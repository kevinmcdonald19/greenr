...
(function (A, d, B) {
    ...
    function p() {
        return["$animate", function (w) {
            return{restrict: "AE", transclude: "element", priority: 1, terminal: !0, require: "^^ngMessages", link: function (n, l, a, c, m) {
                ...
                var e, r;
                c.register(k, r = {test: function (a) {
                    var g = f;
    ...
    d.module("ngMessages", []).directive("ngMessages", ["$animate", function (d) {
        ...
        return{require: "ngMessages", restrict: "AE", controller: ["$element", "$scope", "$attrs", function (a, c, m) {
            function k(a, c) {
                for (var b = c, f = []; b && b !== a;) {
        ...
        return{restrict: "AE", require: "^^ngMessages", link: function (a, c, m) {
