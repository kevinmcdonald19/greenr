...
!function (e, t, n) {
    ...
    !function () {
        ...
        function e(e) {
            ...
            return{KEY_CODE: {COMMA: 188, SEMICOLON: 186, ENTER: 13, ESCAPE: 27, SPACE: 32, PAGE_UP: 33, PAGE_DOWN: 34, END: 35, HOME: 36, LEFT_ARROW: 37, UP_ARROW: 38, RIGHT_ARROW: 39, DOWN_ARROW: 40, TAB: 9, BACKSPACE: 8, DELETE: 46}, CSS: {TRANSITIONEND: "transitionend" + (n ? " webkitTransitionEnd" : ""), ANIMATIONEND: "animationend" + (n ? " webkitAnimationEnd" : ""), TRANSFORM: t("transform"), TRANSFORM_ORIGIN: t("transformOrigin"), TRANSITION: t("transition"), TRANSITION_DURATION: t("transitionDuration"), ANIMATION_PLAY_STATE: t("animationPlayState"), ANIMATION_DURATION: t("animationDuration"), ANIMATION_NAME: t("animationName"), ANIMATION_TIMING: t("animationTimingFunction"), ANIMATION_DIRECTION: t("animationDirection")}, MEDIA: {xs: "(max-width: 599px)", "gt-xs": "(min-width: 600px)", sm: "(min-width: 600px) and (max-width: 959px)", "gt-sm": "(min-width: 960px)", md: "(min-width: 960px) and (max-width: 1279px)", "gt-md": "(min-width: 1280px)", lg: "(min-width: 1280px) and (max-width: 1919px)", "gt-lg": "(min-width: 1920px)", xl: "(min-width: 1920px)", print: "print"}, MEDIA_PRIORITY: ["xl", "gt-lg", "lg", "gt-md", "md", "gt-sm", "sm", "gt-xs", "xs", "print"]}
        }
        ...
        function e(e, n) {
            ...
            function g(e, o, r, a) {
                ...
                for (var d = u(o); ;) {
                    ...
                    if (i(c) ? s = v[c] : n && (s = e ? f() : h(), c = u(s)), null === s || c === a)return null;
                    if (r(s))return s;
            ...
            var v = e || [];
            return{items: o, count: r, inRange: i, contains: p, indexOf: u, itemAt: c, findBy: s, add: l, remove: m, first: h, last: f, next: t.bind(null, g, !1), previous: t.bind(null, g, !0), hasPrevious: d, hasNext: a}
        }
        ...
        function o(o, i, a, d, c, s, l, m, u) {
            ...
            var h = s.startSymbol(), f = s.endSymbol(), g = "{{" === h && "}}" === f, b = function (e, n, o) {
                ...
                return r
            }, v = {dom: {}, now: e.performance ? t.bind(e.performance, e.performance.now) : Date.now || function () {
                return(new Date).getTime()
            }, bidi: function (e, n, r, i) {
                function a(e) {
                    return e ? d(e) ? e : e + "px" : "0"
                }
                ...
                var c = !("rtl" == o[0].dir || "rtl" == o[0].body.dir);
                return 0 == arguments.length ? c ? "ltr" : "rtl" : void(c && t.isDefined(r) ? t.element(e).css(n, a(r)) : !c && t.isDefined(i) && t.element(e).css(n, a(i)))
                ...
                function r(e) {
                    ...
                    e = t.element(e || d)[0];
                    var o = 50, r = t.element('<div class="md-scroll-mask">  <div class="md-scroll-mask-bar"></div></div>').css("z-index", o);
                    return e.appendChild(r[0]), r.on("wheel", n), r.on("touchmove", n), function () {
                        r.off("wheel"), r.off("touchmove"), r[0].parentNode.removeChild(r[0]), delete v.disableScrollAround._enableScrolling
                    }
                }

                function i() {
                    var e = d.parentNode, t = e.style.cssText || "", n = d.style.cssText || "", o = v.scrollTop(d), r = d.clientWidth;
                ...
                if (v.disableScrollAround._count = v.disableScrollAround._count || 0, ++v.disableScrollAround._count, v.disableScrollAround._enableScrolling)return v.disableScrollAround._enableScrolling;
                e = t.element(e);
                var d = o[0].body, c = i(), s = r(n);
                return v.disableScrollAround._enableScrolling = function () {
                    --v.disableScrollAround._count || (c(), s(), delete v.disableScrollAround._enableScrolling)
                }
                ...
                if (this.floatingScrollbars.cached === n) {
                    var e = t.element("<div><div></div></div>").css({width: "100%", "z-index": -1, position: "absolute", height: "35px", "overflow-y": "scroll"});
                ...
                return a(v.supplant('<md-backdrop class="{0}">', [t]))(e)
                ...
                return{$fake: !0, $setTouched: t.noop, $setViewValue: function (e) {
                ...
                var n;
                return function () {
                    var o = this, r = arguments, i = v.now();
                ...
                var c = i(e);
                return!c && r && l.warn(v.supplant("Unable to find node '{0}' in element '{1}'.", [n, e[0].outerHTML])), t.element(c || e)
                ...
                var r = v.nextTick, a = r.timeout, c = r.queue || [];
        ...
        function e(e, n, o, r, i, a) {
            this.compile = function (d) {
                ...
                return t.forEach(u, function (e, n) {
                    ...
                    return n = {locals: e, element: a, link: function (o) {
                        if (e.$scope = o, l) {
                            var r = i(l, e, !0);
        ...
        function o(n, o, r) {
            ...
            var s = navigator.userAgent || navigator.vendor || e.opera, m = s.match(/ipad|iphone|ipod/i), u = s.match(/android/i), p = "undefined" != typeof e.jQuery && t.element === e.jQuery, g = {handler: c, register: a, isHijackingClicks: (m || u) && !p && !f};
            if (g.isHijackingClicks) {
                var b = 6;
                g.handler("click", {options: {maxDistance: b}, onEnd: i("click")}), g.handler("focus", {options: {maxDistance: b}, onEnd: function (e, t) {
                    function n(e) {
                ...
                }}), g.handler("mouseup", {options: {maxDistance: b}, onEnd: i("mouseup")}), g.handler("mousedown", {onStart: function (e) {
                    this.dispatchEvent(e, "mousedown")
                }})
            }
            return g.handler("press", {onStart: function (e, t) {
                this.dispatchEvent(e, "$md.pressdown")
            }, onEnd: function (e, t) {
                this.dispatchEvent(e, "$md.pressup")
            }}).handler("hold", {options: {maxDistance: 6, delay: 500}, onCancel: function () {
                r.cancel(this.state.timeout)
            }, onStart: function (e, n) {
                return this.state.registeredParent ? (this.state.pos = {x: n.x, y: n.y}, void(this.state.timeout = r(t.bind(this, function () {
                ...
                this.onCancel()
            }}).handler("drag", {options: {minDistance: 6, horizontal: !0, cancelMultiplier: 1.5}, onStart: function (e) {
            ...
            }}).handler("swipe", {options: {minVelocity: .65, minDistance: 10}, onEnd: function (e, t) {
                var n;
        ...
        function i() {
            function n(e, n, o) {
                ...
                r.$material = !0, r.pointer = o, r.srcEvent = e, t.extend(r, {clientX: o.x, clientY: o.y, screenX: o.x, screenY: o.y, pageX: o.x, pageY: o.y, ctrlKey: e.ctrlKey, altKey: e.altKey, shiftKey: e.shiftKey, metaKey: e.metaKey}), t.element(o.target).trigger(r)
            }
            ...
            return r.prototype = {options: {}, dispatchEvent: i ? n : o, onStart: t.noop, onMove: t.noop, onEnd: t.noop, onCancel: t.noop, start: function (e, n) {
                if (!this.state.isRunning) {
                    var o = this.getNearestParent(e.target), r = o && o.$mdGesture[this.name] || {};
                    this.state = {isRunning: !0, options: t.extend({}, this.options, r), registeredParent: o}, this.onStart(e, n)
                }
            }, move: function (e, t) {
        ...
        function a(e, n) {
            ...
            function r(e) {
                ...
                t || e.$material || e.isIonicTap || s(e) ? (g = null, "label" == e.target.tagName.toLowerCase() && (g = {x: e.x, y: e.y})) : (e.preventDefault(), e.stopPropagation(), g = null)
            }
        ...
        t.module("material.core.gestures", []).provider("$mdGesture", n).factory("$$MdGestureHandler", i).run(a), n.prototype = {skipClickHijack: function () {
            return f = !0
        ...
        function e() {
            function e(e) {
                ...
                var a = ["onHide", "onShow", "onRemove"], d = {}, c = {presets: {}}, s = {setDefaults: n, addPreset: r, addMethod: o, $get: i};
            ...
            function o(e, o, r, i, a, d, c, s, l, m, u) {
                return function () {
                    function p(e) {
                        e = e || {};
                        var t = new b(e || {}), n = !e.skipHide && $.length ? v.hide() : o.when(!0);
                    ...
                    function h(e, t) {
                        ...
                        if (t = t || {}, t.closeAll) {
                            var i = o.all($.reverse().map(r));
                            return $ = [], i
                        }
                        if (t.closeTo !== n)return o.all($.splice(t.closeTo).map(r));
                        var a = $.pop();
                        return r(a)
                    }
                    ...
                    function g(e) {
                        var n = e ? null : $.shift(), r = t.element(e).length ? t.element(e)[0].parentNode : null;
                        if (r) {
                            var i = $.filter(function (e) {
                                var t = e.options.element[0];
                                return t === r
                            });
                            i.length > 0 && (n = i[0], $.splice($.indexOf(n), 1))
                        }
                    ...
                    function b(u) {
                        function p() {
                            return o(function (e, t) {
                                ...
                                g(u).then(function (t) {
                                    A = b(t, u), k = M(A, u, t.controller).then(e, n)
                                }, n)
                            })
                        }
                        ...
                        function f(e) {
                            return e = e || {}, e.template && (e.template = s.processTemplate(e.template)), t.extend({preserveScope: !1, cancelAutoHide: t.noop, scope: e.scope || i.$new(e.isolateScope), onShow: function (e, t, n) {
        ...
        !function () {
            ...
            function n() {
                return{restrict: "A", priority: "900", compile: function (e, n) {
            ...
            function o(e) {
                return["$timeout", function (n) {
                    return{restrict: "A", priority: -10, compile: function (o) {
            ...
            function r(e) {
                ...
                return["$mdUtil", "$interpolate", "$log", function (o, r, i) {
                    return f = o, g = r, b = i, {restrict: "A", compile: function (o, r) {
                        var i;
            ...
            function a(e, n) {
                ...
                return function (r) {
                    var i = s(n, r || "");
                    t.isDefined(i) && (o && e.removeClass(o), o = i ? n + "-" + i.replace(E, "-") : n, e.addClass(o))
                }
            }
            ...
            function u(e, t, n) {
                var o = t.$normalize(e);
                return t[o] ? t[o].replace(E, "-") : n || null
            }
            ...
            function p(e, t, n) {
                ...
                return e && t.forEach(function (t) {
                    t = n ? t.replace(E, n) : t, o = o || t === e
                }), o
            }

            function h(e) {
                var t, n = {main: "start", cross: "stretch"};
                return e = e || "", 0 != e.indexOf("-") && 0 != e.indexOf(" ") || (e = "none" + e), t = e.toLowerCase().trim().replace(E, "-").split("-"), t.length && "space" === t[0] && (t = [t[0] + "-" + t[1], t[2]]), t.length > 0 && (n.main = t[0] || n.main), t.length > 1 && (n.cross = t[1] || n.cross), y.indexOf(n.main) < 0 && (n.main = "start"), C.indexOf(n.cross) < 0 && (n.cross = "stretch"), n
            }

            var f, g, b, v = /(-gt)?-(sm|md|lg|print)/g, E = /\s+/g, $ = ["grow", "initial", "auto", "none", "noshrink", "nogrow"], M = ["row", "column"], y = ["", "start", "center", "end", "stretch", "space-around", "space-between"], C = ["", "start", "center", "end", "stretch"], A = {enabled: !0, breakpoints: []};
        ...
        function e(e, n) {
            ...
            var r, i = [], a = {};
            return r = {notFoundError: function (t) {
        ...
        function e(e, n) {
            return{controller: t.noop, link: function (t, o, r) {
        ...
        e.$inject = ["$mdButtonInkRipple", "$mdCheckboxInkRipple"], n.$inject = ["$injector"], o.$inject = ["$scope", "$element", "rippleOptions", "$window", "$timeout", "$mdUtil"], o.prototype.color = function (e) {
            ...
            if (this.isRippleAllowed()) {
                ...
                d.css({left: e + "px", top: n + "px", background: "black", width: u + "px", height: u + "px", backgroundColor: o(p), borderColor: o(p)}), this.lastRipple = d, this.clearTimeout(), this.timeout = this.$timeout(function () {
        ...
        function e(e) {
                ...
                o.name = e, o.colors = {}, o.dark = n, n(!1), M.forEach(function (e) {
                    ...
                    o[e + "Palette"] = function (r, i) {
                        ...
                        return Object.keys(a.hues).forEach(function (e) {
                            ...
                            if (-1 == k.indexOf(t))throw new Error("Invalid hue value '%1' in theme %2's %3 color %4. Available hue values: %5".replace("%1", t).replace("%2", o.name).replace("%3", e).replace("%4", r).replace("%5", k.join(", ")))
                        }), o
                    }, o[e + "Color"] = function () {
            ...
            function p(e, o) {
                function r(e) {
                    return e === n || "" === e ? !0 : a.THEMES[e] !== n
                }

                function i(n, i) {
                    function a() {
                        return c = i.controller("mdTheme") || n.data("$mdThemeController"), c && c.$mdTheme || ("default" == E ? "" : E)
                    }
                    ...
                    var c = i.controller("mdTheme"), s = n.attr("md-theme-watch"), l = ($ || t.isDefined(s)) && "false" != s;
                    d(a()), n.on("$destroy", l ? e.$watch(a, d) : t.noop)
                }

                var a = function (t, o) {
                    o === n && (o = t, t = n), t === n && (t = e), a.inherit(o, o)
                };
                return a.THEMES = t.extend({}, u), a.inherit = i, a.registered = r, a.defaultTheme = function () {
                    return E
            ...
            m = {}, u = {};
            var v, E = "default", $ = !1;
            return t.extend(m, e), p.$inject = ["$rootScope", "$log"], v = {definePalette: o, extendPalette: r, theme: c, setNonce: function (e) {
                w = e
                ...
                T = e
            }, $get: p, _LIGHT_DEFAULT_HUES: C, _DARK_DEFAULT_HUES: A, _PALETTES: m, _THEMES: u, _parseRules: i, _rgba: l}
        }

        function o(e, t, n) {
            return{priority: 100, link: {pre: function (o, r, i) {
                var a = {$setTheme: function (t) {
        ...
        function a(e) {
            function n(e, n) {
                var o = e.contrastDefaultColor, r = e.contrastLightColors || [], i = e.contrastStrongLightColors || [], a = e.contrastDarkColors || [];
                "string" == typeof r && (r = r.split(" ")), "string" == typeof i && (i = i.split(" ")), "string" == typeof a && (a = a.split(" ")), delete e.contrastDefaultColor, delete e.contrastLightColors, delete e.contrastStrongLightColors, delete e.contrastDarkColors, t.forEach(e, function (n, d) {
                    function c() {
                        return"light" === o ? a.indexOf(d) > -1 ? v : i.indexOf(d) > -1 ? $ : E : r.indexOf(d) > -1 ? i.indexOf(d) > -1 ? $ : E : v
                    }

                    if (!t.isObject(n)) {
                        var l = s(n);
                        if (!l)throw new Error("Color %1, in palette %2's hue %3, is invalid. Hex or rgb(a) color expected.".replace("%1", n).replace("%2", e.name).replace("%3", d));
            ...
            if (r && 0 !== i.length) {
                ...
                var a = i.split(/\}(?!(\}|'|"|;))/).filter(function (e) {
                    ...
                    return e.trim() + "}"
                }), c = new RegExp("md-(" + M.join("|") + ")", "g");
                M.forEach(function (e) {
                    _[e] = ""
                }), a.forEach(function (e) {
                    for (var t, n = (e.match(c), 0); t = M[n]; n++)if (e.indexOf(".md-" + t) > -1)return _[t] += e;
                    for (n = 0; t = M[n]; n++)if (e.indexOf(t) > -1)return _[t] += e;
                    return _[y] += e
                }), T || t.forEach(u, function (e) {
                    p[e.name] || d(e.name, w)
                })
            }
        }
        ...
        function d(e, t) {
            ...
            p[e] || (M.forEach(function (e) {
                for (var a = i(n, e, _[e]); a.length;) {
                    var d = a.shift();
                    if (d) {
        ...
        function e(e, n, o, r, i) {
            var a;
            return a = {translate3d: function (e, t, n, o) {
                function r(n) {
                ...
                var i = o.element, d = o.bounds, c = "translate3d( {centerX}px, {centerY}px, 0 ) scale( {scaleX}, {scaleY} )", s = t.bind(null, e.supplant, c), l = s({centerX: 0, centerY: 0, scaleX: .5, scaleY: .5});
                if (i || d) {
                    var m = i ? a.clientRect(i) || r() : a.copyRect(d), u = a.copyRect(n[0].getBoundingClientRect()), p = a.centerPointFor(u), h = a.centerPointFor(m);
                    l = s({centerX: h.x - p.x, centerY: h.y - p.y, scaleX: Math.round(100 * Math.min(.5, m.width / u.width)) / 100, scaleY: Math.round(100 * Math.min(.5, m.height / u.height)) / 100})
                }
                return l
            }, toCss: function (e) {
                function n(e, n, r) {
        ...
        t.version.minor >= 4 ? t.module("material.core.animate", []) : !function () {
            ...
            var n = t.forEach, o = t.isDefined(document.documentElement.style.WebkitAppearance), r = o ? "-webkit-" : "", i = (o ? "webkitTransitionEnd " : "") + "transitionend", a = (o ? "webkitAnimationEnd " : "") + "animationend", d = ["$document", function (e) {
                ...
                var i = 0, a = 1, d = 2;
                return r.prototype = {setHost: function (e) {
                    this.host = e || {}
                }, done: function (e) {
            ...
            t.module("material.core.animate", []).factory("$$forceReflow", d).factory("$$AnimateRunner", s).factory("$$rAFMutex", c).factory("$animateCss", ["$window", "$$rAF", "$$AnimateRunner", "$$forceReflow", "$$jqLite", "$timeout", function (t, d, c, s, l, m) {
                function u(o, d) {
                    ...
                    M(o, !0), v(o, d);
                    var C, A, k = !1;
                    return{close: t.close, start: function () {
                        function t() {
                            return k ? void 0 : (k = !0, C && A && o.off(C, A), p(o, d), b(o, d), n(s, function (t) {
                                l.style[e(t[0])] = ""
                            }), u.complete(!0), u)
                        }
                        ...
                        return g(function () {
                            ...
                            var f = c.delay, g = 1e3 * f, b = c.duration, v = 1e3 * b, $ = Date.now();
                            C = [], c.transitionDuration && C.push(i), c.animationDuration && C.push(a), C = C.join(" "), A = function (e) {
                                ...
                                Math.max(o - $, 0) >= g && r >= b && t()
                            }, o.on(C, A), E(o, d), m(t, g + 1.5 * v, !1)
                        }), u
                    }}
                }
                ...
                function h(e) {
                    ...
                    var r = $(e), i = t.getComputedStyle(r), a = f(i[n("transitionDuration")]), d = f(i[n("animationDuration")]), c = f(i[n("transitionDelay")]), s = f(i[n("animationDelay")]);
                    d *= parseInt(i[n("animationIterationCount")], 10) || 1;
                    var l = Math.max(d, a), m = Math.max(s, c);
                    return{duration: l, delay: m, animationDuration: d, transitionDuration: a, animationDelay: s, transitionDelay: c}
                }
                ...
                function M(t, n) {
                    var o = $(t), i = e(r + "transition-delay");
                    o.style[i] = n ? "-9999s" : ""
                }
        ...
        function e(e) {
            return{restrict: "E", link: function (t, n, o) {
        ...
        function n(e) {
            function n(e, n, i, a, d, c, s) {
                function l(o, r, s, l) {
                    r = i.extractElementByName(r, "md-bottom-sheet"), r.attr("tabindex", "-1"), s.disableBackdrop || (p = i.createBackdrop(o, "_md-bottom-sheet-backdrop md-opaque"), p[0].tabIndex = -1, s.clickOutsideToClose && p.on("click", function () {
                        i.nextTick(d.cancel, !0)
                    }), a.inherit(p, s.parent), e.enter(p, s.parent, null));
                    var m = new u(r, s.parent);
                    return s.bottomSheet = m, a.inherit(m.element, s.parent), s.disableParentScroll && (s.restoreScroll = i.disableScrollAround(m.element, s.parent)), e.enter(m.element, s.parent, p).then(function () {
                        var e = i.findFocusTarget(r) || t.element(r[0].querySelector("button") || r[0].querySelector("a") || r[0].querySelector("[ng-click]")) || p;
                        s.escapeToClose && (s.rootElementKeyupCallback = function (e) {
                            e.keyCode === n.KEY_CODE.ESCAPE && i.nextTick(d.cancel, !0)
                        }, c.on("keyup", s.rootElementKeyupCallback), e && e.focus())
                    })
                }

                function m(t, n, o) {
                    var r = o.bottomSheet;
                    return o.disableBackdrop || e.leave(p), e.leave(r.element).then(function () {
                ...
                function u(e, t) {
                    ...
                    return t.on("$md.dragstart", a).on("$md.drag", c).on("$md.dragend", l), {element: e, cleanup: function () {
                        m(), t.off("$md.dragstart", a), t.off("$md.drag", c), t.off("$md.dragend", l)
                    }}
                }

                var p;
                return{themable: !0, onShow: l, onRemove: m, disableBackdrop: !1, escapeToClose: !0, clickOutsideToClose: !0, disableParentScroll: !0}
            }

            var o = .5, r = 80;
            return n.$inject = ["$animate", "$mdConstant", "$mdUtil", "$mdTheming", "$mdBottomSheet", "$rootElement", "$mdGesture"], e("$mdBottomSheet").setDefaults({methods: ["disableParentScroll", "escapeToClose", "clickOutsideToClose"], options: n})
        }
        ...
        t.module("material.components.backdrop", ["material.core"]).directive("mdBackdrop", ["$mdTheming", "$animate", "$rootElement", "$window", "$log", "$$rAF", "$document", function (e, t, n, o, r, i, a) {
            function d(d, s, l) {
                ...
                t.pin && t.pin(s, n), i(function () {
                    ...
                    s.parent().length && e.inherit(s, s.parent())
                })
            }
        ...
        function e(e, n, o, r, i, a) {
            function d(d, s) {
                var l = d.children(), m = s.hasOwnProperty("mdIndeterminate");
                return s.type = "checkbox", s.tabindex = s.tabindex || "0", d.attr("role", s.type), d.on("click", function (e) {
                    ...
                    function h(e) {
                        ...
                        t !== o.KEY_CODE.SPACE && t !== o.KEY_CODE.ENTER || (e.preventDefault(), s.hasClass("md-focused") || s.addClass("md-focused"), f(e))
                    }

                    function f(e) {
                        s[0].hasAttribute("disabled") || d.$apply(function () {
                            var t = l.ngChecked ? l.checked : !u.$viewValue;
                            u.$setViewValue(t, e && e.type), u.$render()
                        })
                    }

                    function g() {
                        u.$viewValue && !v ? s.addClass(c) : s.removeClass(c)
                    }

                    function b(e) {
                        v = e !== !1, v && s.attr("aria-checked", "mixed"), s.toggleClass("md-indeterminate", v)
                    }

                    var v;
                    u = u || i.fakeNgModel(), r(s), m && (b(), d.$watch(l.mdIndeterminate, b)), l.ngChecked && d.$watch(d.$eval.bind(d, l.ngChecked), u.$setViewValue.bind(u)), p("ngDisabled", "tabindex", {"true": "-1", "false": l.tabindex}), n.expectWithText(s, "aria-label"), e.link.pre(d, {on: t.noop, 0: {}}, l, [u]), d.mouseActive = !1, s.on("click", f).on("keypress", h).on("mousedown", function () {
            ...
            e = e[0];
            var c = "md-checked";
            return{restrict: "E", transclude: !0, require: "?ngModel", priority: 210, template: '<div class="_md-container" md-ink-ripple md-ink-ripple-checkbox><div class="_md-icon"></div></div><div ng-transclude class="_md-label"></div>', compile: d}
        }
        ...
        function e(e) {
            ...
            return{restrict: "E", controller: ["$scope", "$element", t], link: function (t, o, r) {
                o[0];
        ...
        !function () {
            function e() {
                return{template: '<table aria-hidden="true" class="md-calendar-day-header"><thead></thead></table><div class="md-calendar-scroll-mask"><md-virtual-repeat-container class="md-calendar-scroll-container" md-offset-size="' + (r - o) + '"><table role="grid" tabindex="0" class="md-calendar" aria-readonly="true"><tbody role="rowgroup" md-virtual-repeat="i in ctrl.items" md-calendar-month md-month-offset="$index" class="md-calendar-month" md-start-index="ctrl.getSelectedMonthIndex()" md-item-size="' + o + '"></tbody></table></md-virtual-repeat-container></div>', scope: {minDate: "=mdMinDate", maxDate: "=mdMaxDate", dateFilter: "=mdDateFilter"}, require: ["ngModel", "mdCalendar"], controller: n, controllerAs: "ctrl", bindToController: !0, link: function (e, t, n, o) {
                    var r = o[0], i = o[1];
        ...
        !function () {
            function e() {
                return{require: ["^^mdCalendar", "mdCalendarMonth"], scope: {offset: "=mdMonthOffset"}, controller: n, controllerAs: "mdMonthCtrl", bindToController: !0, link: function (e, t, n, o) {
                    var r = o[0], i = o[1];
        ...
        !function () {
            t.module("material.components.datepicker").config(["$provide", function (e) {
                ...
                t.prototype.$get = function (e) {
                    ...
                    var l = "Calendar", m = "Open calendar", u = {months: this.months || e.DATETIME_FORMATS.MONTH, shortMonths: this.shortMonths || e.DATETIME_FORMATS.SHORTMONTH, days: this.days || e.DATETIME_FORMATS.DAY, shortDays: this.shortDays || d, dates: this.dates || c, firstDayOfWeek: this.firstDayOfWeek || 0, formatDate: this.formatDate || t, parseDate: this.parseDate || n, isDateComplete: this.isDateComplete || o, monthHeaderFormatter: this.monthHeaderFormatter || r, weekNumberFormatter: this.weekNumberFormatter || i, longDateFormatter: this.longDateFormatter || a, msgCalendar: this.msgCalendar || l, msgOpenCalendar: this.msgOpenCalendar || m};
                    return u
        ...
        !function () {
            function n() {
                return{template: '<md-button class="md-datepicker-button md-icon-button" type="button" tabindex="-1" aria-hidden="true" ng-click="ctrl.openCalendarPane($event)"><md-icon class="md-datepicker-calendar-icon" md-svg-icon="md-calendar"></md-icon></md-button><div class="md-datepicker-input-container" ng-class="{\'md-datepicker-focused\': ctrl.isFocused}"><input class="md-datepicker-input" aria-haspopup="true" ng-focus="ctrl.setFocused(true)" ng-blur="ctrl.setFocused(false)"><md-button type="button" md-no-ink class="md-datepicker-triangle-button md-icon-button" ng-click="ctrl.openCalendarPane($event)" aria-label="{{::ctrl.dateLocale.msgOpenCalendar}}"><div class="md-datepicker-expand-triangle"></div></md-button></div><div class="md-datepicker-calendar-pane md-whiteframe-z1"><div class="md-datepicker-input-mask"><div class="md-datepicker-input-mask-opaque"></div></div><div class="md-datepicker-calendar"><md-calendar role="dialog" aria-label="{{::ctrl.dateLocale.msgCalendar}}" md-min-date="ctrl.minDate" md-max-date="ctrl.maxDate"md-date-filter="ctrl.dateFilter"ng-model="ctrl.date" ng-if="ctrl.isCalendarOpen"></md-calendar></div></div>', require: ["ngModel", "mdDatepicker", "?^mdInputContainer"], scope: {minDate: "=mdMinDate", maxDate: "=mdMaxDate", placeholder: "@mdPlaceholder", dateFilter: "=mdDateFilter"}, controller: o, controllerAs: "ctrl", bindToController: !0, link: function (e, t, n, o) {
            ...
            o.$inject = ["$scope", "$element", "$attrs", "$compile", "$timeout", "$window", "$mdConstant", "$mdTheming", "$mdUtil", "$mdDateLocale", "$$mdDateUtil", "$$rAF"], o.prototype.configureNgModel = function (e) {
                ...
                Object.defineProperty(this, "placeholder", {get: function () {
                ...
                this.$element.removeClass("md-datepicker-open"), this.calendarPane.classList.remove("md-pane-open"), this.calendarPane.classList.remove("md-datepicker-pos-adjusted"), this.isCalendarOpen && this.$mdUtil.enableScrolling(), this.calendarPane.parentNode && this.calendarPane.parentNode.removeChild(this.calendarPane)
                ...
                this.isCalendarOpen && (this.detachCalendarPane(), this.isCalendarOpen = !1, this.calendarPaneOpenedFrom.focus(), this.calendarPaneOpenedFrom = null, this.ngModelCtrl.$setTouched(), this.documentElement.off("click touchstart", this.bodyClickHandler), e.removeEventListener("resize", this.windowResizeHandler))
        ...
        !function () {
            t.module("material.components.datepicker").factory("$$mdDateUtil", function () {
                ...
                return{getFirstDateOfMonth: e, getNumberOfDaysInMonth: n, getDateInNextMonth: o, getDateInPreviousMonth: r, isInNextMonth: d, isInPreviousMonth: c, getDateMidpoint: s, isSameMonthAndYear: i, getWeekOfMonth: l, incrementDays: m, incrementMonths: u, getLastDateOfMonth: h, isSameDay: a, getMonthDistance: p, isValidDate: f, setDateTimeToMidnight: g, createDateAtMidnight: b, isDateWithinRange: v}
            })
        }()
    }(), function () {
        function e(e, n, o) {
            return{restrict: "E", link: function (r, i, a) {
                n(i), e(function () {
                    function e() {
        ...
        function o(e) {
            function o(e, t, n) {
                return{template: ['<md-dialog md-theme="{{ dialog.theme }}" aria-label="{{ dialog.ariaLabel }}" ng-class="dialog.css">', '  <md-dialog-content class="md-dialog-content" role="document" tabIndex="-1">', '    <h2 class="md-title">{{ dialog.title }}</h2>', '    <div ng-if="::dialog.mdHtmlContent" class="_md-dialog-content-body" ', '        ng-bind-html="::dialog.mdHtmlContent"></div>', '    <div ng-if="::!dialog.mdHtmlContent" class="_md-dialog-content-body">', "      <p>{{::dialog.mdTextContent}}</p>", "    </div>", '    <md-input-container md-no-float ng-if="::dialog.$type == \'prompt\'" class="md-prompt-input-container">', '      <input ng-keypress="dialog.keypress($event)" md-autofocus ng-model="dialog.result" placeholder="{{::dialog.placeholder}}">', "    </md-input-container>", "  </md-dialog-content>", "  <md-dialog-actions>", '    <md-button ng-if="dialog.$type === \'confirm\' || dialog.$type === \'prompt\'"               ng-click="dialog.abort()" class="md-primary">', "      {{ dialog.cancel }}", "    </md-button>", '    <md-button ng-click="dialog.hide()" class="md-primary" md-autofocus="dialog.$type===\'alert\'">', "      {{ dialog.ok }}", "    </md-button>", "  </md-dialog-actions>", "</md-dialog>"].join("").replace(/\s\s+/g, ""), controller: function () {
                    this.hide = function () {
            ...
            function r(e, o, r, d, c, s, l, m, u, p) {
                ...
                function f(e, n, o, i) {
                    function a() {
                        ...
                        e.length > 0 && u.warn("Using a class of md-actions is deprecated, please use <md-dialog-actions>.")
                    }
                    ...
                    return t.element(s[0].body).addClass("md-dialog-is-showing"), b(o), $(n.find("md-dialog"), o), E(e, n, o), C(n, o).then(function () {
                        v(n, o), M(n, o), a(), d()
                    })
                }
                ...
                function b(e) {
                    function o(e, o) {
                        var r = t.element(e || {});
                        if (r && r.length) {
                            var i = {top: 0, left: 0, height: 0, width: 0}, a = t.isFunction(r[0].getBoundingClientRect);
                            return t.extend(o || {}, {element: a ? r : n, bounds: a ? r[0].getBoundingClientRect() : t.extend({}, i, r[0]), focus: t.bind(r, r.focus)})
                        }
                    }
                    ...
                    e.origin = t.extend({element: null, bounds: null, focus: t.noop}, e.origin || {}), e.parent = r(e.parent, m), e.closeTo = o(r(e.closeTo)), e.openFrom = o(r(e.openFrom)), e.targetEvent && (e.origin = o(e.targetEvent.target, e.origin))
                }
                ...
                function v(n, o) {
                    ...
                    if (i.on("resize", a), c.push(function () {
                        ...
                        var p, h = n, f = function (e) {
                            ...
                            p === h[0] && e.target === h[0] && (e.stopPropagation(), e.preventDefault(), s())
                        };
                        h.on("mousedown", f), h.on("mouseup", g), c.push(function () {
                ...
                function E(e, t, n) {
                    n.disableParentScroll && (n.restoreScroll = r.disableScrollAround(t, n.parent)), n.hasBackdrop && (n.backdrop = r.createBackdrop(e, "_md-dialog-backdrop md-opaque"), c.enter(n.backdrop, n.parent)), n.hideBackdrop = function (e) {
                ...
                function $(e, t) {
                    var n = "alert" === t.$type ? "alertdialog" : "dialog", d = e.find("md-dialog-content"), c = "dialogContent_" + (e.attr("id") || r.nextUid());
                    e.attr({role: n, tabIndex: "-1"}), 0 === d.length && (d = e), d.attr("id", c), e.attr("aria-describedby", c), t.ariaLabel ? o.expect(e, "aria-label", t.ariaLabel) : o.expectAsync(e, "aria-label", function () {
                        var e = d.text().split(/\s+/);
                        return e.length > 3 && (e = e.slice(0, 3).concat("...")), e.join(" ")
                    }), i = document.createElement("div"), i.classList.add("_md-dialog-focus-trap"), i.tabIndex = 0, a = i.cloneNode(!1);
                    var s = function () {
                        e.focus()
                    };
                    i.addEventListener("focus", s), a.addEventListener("focus", s), e[0].parentNode.insertBefore(i, e[0]), e.after(a)
                }
                ...
                function M(e, t) {
                    function n(e) {
                        for (; e.parentNode;) {
                            ...
                            for (var t = e.parentNode.children, r = 0; r < t.length; r++)e === t[r] || k(t[r], ["SCRIPT", "STYLE"]) || t[r].setAttribute("aria-hidden", o);
                            n(e = e.parentNode)
                        }
                    }
                ...
                function C(e, t) {
                    ...
                    var n = e.find("md-dialog"), o = r.dom.animator, i = o.calculateZoomToOrigin, a = {transitionInClass: "_md-transition-in", transitionOutClass: "_md-transition-out"}, d = o.toTransformCss(i(n, t.openFrom || t.origin)), c = o.toTransformCss("");
                    return t.fullscreen && n.addClass("md-dialog-fullscreen"), o.translate3d(n, d, c, a).then(function (e) {
                        return t.reverseAnimate = function () {
                            return delete t.reverseAnimate, t.closeTo ? (a = {transitionInClass: "_md-transition-out", transitionOutClass: "_md-transition-in"}, d = c, c = o.toTransformCss(i(n, t.closeTo)), o.translate3d(n, d, c, a)) : e(o.toTransformCss(i(n, t.origin)))
                        }, !0
                    })
                }
                ...
                return{hasBackdrop: !0, isolateScope: !0, onShow: f, onShowing: h, onRemove: g, clickOutsideToClose: !1, escapeToClose: !0, targetEvent: null, closeTo: null, openFrom: null, focusOnOpen: !0, disableParentScroll: !0, autoWrap: !0, fullscreen: !1, transformTemplate: function (e, t) {
                    function n(e) {
            ...
            var i, a;
            return o.$inject = ["$mdDialog", "$mdTheming", "$mdConstant"], r.$inject = ["$mdDialog", "$mdAria", "$mdUtil", "$mdConstant", "$animate", "$document", "$window", "$rootElement", "$log", "$injector"], e("$mdDialog").setDefaults({methods: ["disableParentScroll", "hasBackdrop", "clickOutsideToClose", "escapeToClose", "targetEvent", "closeTo", "openFrom", "parent", "fullscreen"],
                options: r}).addPreset("alert", {methods: ["title", "htmlContent", "textContent", "content", "ariaLabel", "ok", "theme", "css"], options: o}).addPreset("confirm", {methods: ["title", "htmlContent", "textContent", "content", "ariaLabel", "ok", "cancel", "theme", "css"], options: o}).addPreset("prompt", {methods: ["title", "htmlContent", "textContent", "content", "placeholder", "ariaLabel", "ok", "cancel", "theme", "css"], options: o})
        }
        ...
        !function () {
            function e() {
                return{restrict: "E", require: ["^?mdFabSpeedDial", "^?mdFabToolbar"], compile: function (e, n) {
                    var o = e.children(), r = !1;
                    t.forEach(["", "data-", "x-"], function (e) {
                        r = r || !!o.attr(e + "ng-repeat")
        ...
        !function () {
            function e(e, n, o, r, i, a) {
                function d() {
                    N.direction = N.direction || "down", N.isOpen = N.isOpen || !1, l(), n.addClass("_md-animations-waiting")
                }
                ...
                function s(e) {
                    "click" == e.type && w(e), "focusout" != e.type || H || (H = a(function () {
                        N.close()
                    }, 100, !1)), "focusin" == e.type && H && (a.cancel(H), H = null)
                }
                ...
                function u() {
                    n[0].scrollHeight > 0 ? o.addClass(n, "_md-animations-ready").then(function () {
                        n.removeClass("_md-animations-waiting")
                    }) : 10 > S && (a(u, 100), S += 1)
                }
                ...
                function E(e, n) {
                    ...
                    var r = t.element(o[N.currentActionIndex]).children()[0];
                ...
                function w(e) {
                    k(e.target) && N.toggle(), T(e.target) && N.close()
                }
        ...
        !function () {
            ...
            function o(n) {
                ...
                function r(n) {
                    if (!n.hasClass("_md-animations-waiting") || n.hasClass("_md-animations-ready")) {
                        var o = n[0], r = n.controller("mdFabSpeedDial"), i = o.querySelectorAll(".md-fab-action-item"), a = o.querySelector("md-fab-trigger"), d = o.querySelector("._md-css-variables"), c = parseInt(e.getComputedStyle(d).zIndex);
                ...
                return{addClass: function (e, t, n) {
            ...
            function r(n) {
                ...
                function r(n) {
                    var o = n[0], r = n.controller("mdFabSpeedDial"), i = o.querySelectorAll(".md-fab-action-item"), d = o.querySelector("._md-css-variables"), c = parseInt(e.getComputedStyle(d).zIndex);
                    t.forEach(i, function (e, t) {
                        var n = e.style, o = t * a;
        ...
        !function () {
            function n() {
                function e(e, t, n) {
                    t.addClass("md-fab-toolbar"), t.find("md-fab-trigger").find("button").prepend('<div class="_md-fab-toolbar-background"></div>')
                }

                return{restrict: "E", transclude: !0, template: '<div class="_md-fab-toolbar-wrapper">  <div class="_md-fab-toolbar-content" ng-transclude></div></div>', scope: {direction: "@?mdDirection", isOpen: "=?mdOpen"}, bindToController: !0, controller: "MdFabController", controllerAs: "vm", link: e}
            }

            function o() {
                function n(n, o, r) {
                    if (o) {
                        var i = n[0], a = n.controller("mdFabToolbar"), d = i.querySelector("._md-fab-toolbar-background"), c = i.querySelector("md-fab-trigger button"), s = i.querySelector("md-toolbar"), l = i.querySelector("md-fab-trigger button md-icon"), m = n.find("md-fab-actions").children();
                        if (c && d) {
                ...
                return{addClass: function (e, t, o) {
                    n(e, t, o), o()
        ...
        function e(e, o, r, i) {
            function a(n, a, d, c) {
                ...
                function u(e) {
                    var o = g(), i = {tileSpans: b(o), colCount: v(), rowMode: M(), rowHeight: $(), gutter: E()};
                    if (e || !t.equals(i, k)) {
                        var d = r(i.colCount, i.tileSpans, o).map(function (e, n) {
                            return{grid: {element: a, style: f(i.colCount, n, i.gutter, i.rowMode, i.rowHeight)}, tiles: e.map(function (e, r) {
                                return{element: t.element(o[r]), style: h(e.position, e.spans, i.colCount, n, i.gutter, i.rowMode, i.rowHeight)}
                            })}
                        }).reflow().performance();
                        n.mdOnLayout({$event: {performance: d}}), k = i
                    }
                }
                ...
                function h(e, t, n, o, r, i, a) {
                    var d = 1 / n * 100, c = (n - 1) / n, s = _({share: d, gutterShare: c, gutter: r}), l = {left: x({unit: s, offset: e.col, gutter: r}), width: N({unit: s, span: t.col, gutter: r}), paddingTop: "", marginTop: "", top: "", height: ""};
                    switch (i) {
                        case"fixed":
                            l.top = x({unit: a, offset: e.row, gutter: r}), l.height = N({unit: a, span: t.row, gutter: r});
                            break;
                        case"ratio":
                            var m = d / a, u = _({share: m, gutterShare: c, gutter: r});
                            l.paddingTop = N({unit: u, span: t.row, gutter: r}), l.marginTop = x({unit: u, offset: e.row, gutter: r});
                            break;
                        case"fit":
                            var p = (o - 1) / o, m = 1 / o * 100, u = _({share: m, gutterShare: p, gutter: r});
                            l.top = x({unit: u, offset: e.row, gutter: r}), l.height = N({unit: u, span: t.row, gutter: r})
                    }
                    return l
                }
                ...
                function f(e, t, n, o, r) {
                    ...
                    switch (o) {
                        case"fixed":
                            i.height = N({unit: r, span: t, gutter: n}), i.paddingBottom = "";
                            break;
                        case"ratio":
                            var a = 1 === e ? 0 : (e - 1) / e, d = 1 / e * 100, c = d * (1 / r), s = _({share: c, gutterShare: a, gutter: n});
                            i.height = "", i.paddingBottom = N({unit: s, span: t, gutter: n});
                            break;
                        case"fit":
                    }
                    return i
                ...
                function b(e) {
                    return[].map.call(e, function (e) {
                        ...
                        return{row: parseInt(i.getResponsiveAttribute(n.$attrs, "md-rowspan"), 10) || 1, col: parseInt(i.getResponsiveAttribute(n.$attrs, "md-colspan"), 10) || 1}
                    })
                }
                ...
                n.$on("$destroy", l);
                var k, T = e.startSymbol(), w = e.endSymbol(), _ = e(p("share") + "% - (" + p("gutter") + " * " + p("gutterShare") + ")"), x = e("calc((" + p("unit") + " + " + p("gutter") + ") * " + p("offset") + ")"), N = e("calc((" + p("unit") + ") * " + p("span") + " + (" + p("span") + " - 1) * " + p("gutter") + ")")
            }
        ...
        function o(e) {
            ...
            function r(e, t) {
                ...
                var d = 0, c = 0, s = a();
                return{positioning: t.map(function (e, t) {
        ...
        function r(e) {
            ...
            return{restrict: "E", require: "^mdGridList", template: "<figure ng-transclude></figure>", transclude: !0, scope: {}, controller: ["$attrs", function (e) {
                this.$attrs = e
            }], link: n}
        }
        ...
        t.module("material.components.gridList", ["material.core"]).directive("mdGridList", e).directive("mdGridTile", r).directive("mdGridTileFooter", i).directive("mdGridTileHeader", i).factory("$mdGridLayout", o), e.$inject = ["$interpolate", "$mdConstant", "$mdGridLayout", "$mdMedia"], n.$inject = ["$mdUtil"], n.prototype = {invalidateTiles: function () {
        ...
        function n(e, t) {
            function n(t, n) {
                e(n);
                var o = n[0].querySelector(i), r = n[0].querySelector(a);
                o && n.addClass("md-icon-left"), r && n.addClass("md-icon-right")
            }
            ...
            var r = ["INPUT", "TEXTAREA", "SELECT", "MD-SELECT"], i = r.reduce(function (e, t) {
                return e.concat(["md-icon ~ " + t, ".md-icon ~ " + t])
            }, []).join(","), a = r.reduce(function (e, t) {
        ...
        function o() {
            return{restrict: "E", require: "^?mdInputContainer", link: function (e, t, n, o) {
                !o || n.mdNoFloat || t.hasClass("_md-container-ignore") || (o.label = t, e.$on("$destroy", function () {
                    o.label = null
                }))
            }}
        }
        ...
        function r(e, n, o, r) {
            function i(i, a, d, c) {
                ...
                function l() {
                    p.label && d.$observe("required", function (e) {
                        p.label.toggleClass("md-required", e && !b)
                    })
                }

                function m() {
                    p.setHasValue(a.val().length > 0 || (a[0].validity || {}).badInput)
                }

                function u() {
                    function o() {
                        if (a.addClass("md-no-flex").attr("rows", 1), m) {
                            u || (p.style.minHeight = 0, u = a.prop("clientHeight"), p.style.minHeight = null);
                            var e = Math.round(Math.round(c() / u)), t = Math.min(e, m);
                            a.css("height", u * t + "px").attr("rows", t).toggleClass("_md-textarea-scrollable", e >= m)
                        } else {
                            a.css("height", "auto"), p.scrollTop = 0;
                            var n = c();
                            n && a.css("height", n + "px")
                        }
                        a.removeClass("md-no-flex")
                    }

                    function c() {
                        var e = p.offsetHeight, t = p.scrollHeight - e;
                        return e + (t > 0 ? t : 0)
                    }

                    function s(e) {
                        p.scrollTop = 0;
                        var t = p.scrollHeight - p.offsetHeight, n = p.offsetHeight + t;
                        p.style.height = n + "px"
                    }
                    ...
                    if (!d.hasOwnProperty("mdNoAutogrow")) {
                        var m = d.hasOwnProperty("rows") ? parseInt(d.rows) : NaN, u = null, p = a[0];
                        if (r(function () {
                            e.nextTick(o)
                        }, 10, !1), h ? (f.$formatters.unshift(l), f.$parsers.unshift(l)) : a.on("input", o), m || a.attr("rows", 1).on("scroll", s), t.element(n).on("resize", o), i.$on("$destroy", function () {
                            t.element(n).off("resize", o)
                        }), d.hasOwnProperty("mdDetectHidden")) {
                            var g = function () {
                                var e = !1;
                                return function () {
                                    var t = 0 === p.offsetHeight;
                                    t === !1 && e === !0 && o(), e = t
                                }
                            }();
                            i.$watch(function () {
                ...
                var p = c[0], h = !!c[1], f = c[1] || e.fakeNgModel(), g = t.isDefined(d.readonly), b = e.parseAttributeBoolean(d.mdNoAsterisk);
                if (p) {
                    if ("hidden" === d.type)return void a.attr("aria-hidden", "true");
                    if (p.input)throw new Error("<md-input-container> can only have *one* <input>, <textarea> or <md-select> child element!");
                    p.input = a, l();
                    var v = t.element('<div class="md-errors-spacer">');
                    a.after(v), p.label || o.expect(a, "aria-label", a.attr("placeholder")), a.addClass("md-input"), a.attr("id") || a.attr("id", "input_" + e.nextUid()), "textarea" === a[0].tagName.toLowerCase() && u(), h || m();
                    var E = p.isErrorGetter || function () {
                        return f.$invalid && (f.$touched || $())
                    }, $ = function () {
                        var n = e.getClosest(a, "form"), o = n ? t.element(n).controller("form") : null;
                        return o ? o.$submitted : !1
                    };
                    i.$watch(E, p.setInvalid), f.$parsers.push(s), f.$formatters.push(s), a.on("input", m), g || a.on("focus", function (t) {
                        e.nextTick(function () {
                            p.setFocused(!0)
                        })
                    }).on("blur", function (t) {
            ...
            return{restrict: "E", require: ["^?mdInputContainer", "?ngModel"], link: i}
        }
        ...
        function d(e) {
            function t(t, n, o) {
                ...
                if ("INPUT" === n[0].nodeName || "TEXTAREA" === n[0].nodeName) {
                    var a = !1;
                    n.on("focus", r).on("mouseup", i), t.$on("$destroy", function () {
                        n.off("focus", r).off("mouseup", i)
                    })
                }
            }
        ...
        function l(e, t) {
            return{addClass: function (n, o, r) {
                var i = v(n);
        ...
        function f(e, t) {
            ...
            return t(e, {event: "enter", structural: !0, from: {opacity: 0, "margin-top": -n + "px"}, to: {opacity: 1, "margin-top": "0"}, duration: .3})
        }

        function g(t, n) {
            var o = t[0].offsetHeight, r = e.getComputedStyle(t[0]);
            return 0 == r.opacity ? n(t, {}) : n(t, {event: "leave", structural: !0, from: {opacity: 1, "margin-top": 0}, to: {opacity: 0, "margin-top": -o + "px"}, duration: .3})
        }
        ...
        function n(e, n, o, r) {
            ...
            return{restrict: "E", controller: "MdListController", compile: function (a, d) {
                function c() {
                ...
                function s(e) {
                    if ("div" == e)$ = t.element('<div class="_md-no-style _md-list-item-inner">'), $.append(a.contents()), a.addClass("_md-proxy-focus"); else {
                        $ = t.element('<div class="md-button _md-no-style">   <div class="_md-list-item-inner"></div></div>');
                        var n = t.element('<md-button class="_md-no-style" md-no-focus-style></md-button>');
                        n[0].setAttribute("aria-label", a[0].textContent), u(a[0], n[0]), $.prepend(n), $.children().eq(1).append(a.contents()), a.addClass("_md-button-wrap")
                    }
                    a[0].setAttribute("tabindex", "-1"), a.append($)
                }

                function l() {
                    var e = t.element('<div class="_md-secondary-container">');
                    t.forEach(E, function (t) {
                        m(t, e)
                    });
                    var n = t.element('<div class="flex"></div>');
                    $.append(n), $.append(e)
                }
                ...
                function m(n, o) {
                    if (n && !h(n) && n.hasAttribute("ng-click")) {
                        ...
                        var r = t.element('<md-button class="md-secondary md-icon-button">');
                        u(n, r[0]), n.setAttribute("tabindex", "-1"), r.append(n), n = r[0]
                    }
                    n && (!f(n) || !d.ngClick && p(n)) && t.element(n).removeClass("md-secondary"), a.addClass("md-with-secondary"), o.append(n)
                }

                function u(e, n) {
                    var o = ["ng-if", "ng-click", "aria-label", "ng-disabled", "ui-sref", "href", "ng-href", "ng-attr-ui-sref", "ui-sref-opts"];
                ...
                function g(e, a, d, c) {
                    function s() {
                        u && u.children && !g && t.forEach(i, function (e) {
                            t.forEach(u.querySelectorAll(e + ":not(.md-secondary)"), function (e) {
                                m.push(e)
                            })
                        })
                    }
                    ...
                    function l() {
                        (1 == m.length || g) && (a.addClass("md-clickable"), g || c.attachRipple(e, t.element(a[0].querySelector("._md-no-style"))))
                    }

                    var m = [], u = a[0].firstElementChild, p = a.hasClass("_md-button-wrap"), h = p ? u.firstElementChild : u, g = h && f(h);
                    s(), l(), a.hasClass("_md-proxy-focus") && m.length && t.forEach(m, function (n) {
                    ...
                    var b = function (e) {
                        if ("INPUT" != e.target.nodeName && "TEXTAREA" != e.target.nodeName && !e.target.isContentEditable) {
                            var t = e.which || e.keyCode;
                            t == n.KEY_CODE.SPACE && h && (h.click(), e.preventDefault(), e.stopPropagation())
                        }
                    };
                    g || m.length || h && h.addEventListener("keypress", b), a.off("click"), a.off("keypress"), 1 == m.length && h && a.children().eq(0).on("click", function (e) {
                        var n = o.getClosest(e.target, "BUTTON");
                        !n && h.contains(e.target) && t.forEach(m, function (n) {
                            e.target === n || n.contains(e.target) || t.element(n).triggerHandler("click")
                        })
                    }), e.$on("$destroy", function () {
                        h && h.removeEventListener("keypress", b)
                    })
                }

                var b, v, E = a[0].querySelectorAll(".md-secondary"), $ = a;
                if (a[0].setAttribute("role", "listitem"), d.ngClick || d.ngHref || d.href || d.uiSref || d.ngAttrUiSref)s("button"); else {
                    for (var M, y = 0; M = i[y]; ++y)if (v = a[0].querySelector(M)) {
                        b = !0;
                        break
                    }
                    b ? s("div") : a[0].querySelector("md-button:not(.md-secondary):not(.md-exclude)") || a.addClass("_md-no-proxy")
                }
                return l(), c(), g
            }}
        }
        ...
        function e(e, n, o) {
            ...
            function i(r, i, m) {
                function u() {
                    m.$observe("value", function (e) {
                        var t = a(e);
                        i.attr("aria-valuenow", t), h() != l && f(E, t)
                    }), m.$observe("mdBufferValue", function (e) {
                        f(v, a(e))
                    }), m.$observe("mdMode", function (e) {
                        switch (g && $.removeClass(g), e) {
                            case l:
                            case s:
                            case d:
                            case c:
                                $.addClass(g = "_md-mode-" + e);
                                break;
                            default:
                                $.addClass(g = "_md-mode-" + c)
                        }
                    })
                }
                ...
                function p() {
                    if (t.isUndefined(m.mdMode)) {
                        var e = t.isDefined(m.value), r = e ? d : c, a = "Auto-adding the missing md-mode='{0}' to the ProgressLinear element";
                        o.debug(n.supplant(a, [r])), i.attr("md-mode", r), m.mdMode = r
                    }
                }
                ...
                function f(e, o) {
                    if (h()) {
                        var r = n.supplant("translateX({0}%) scale({1},1)", [(o - 100) / 2, o / 100]), i = b({transform: r});
                        t.element(e).css(i)
                    }
                }

                e(i);
                var g, b = n.dom.animator.toCss, v = t.element(i[0].querySelector("._md-bar1")), E = t.element(i[0].querySelector("._md-bar2")), $ = t.element(i[0].querySelector("._md-container"));
                i.attr("md-mode", h()), p(), u()
            }
            ...
            var d = "determinate", c = "indeterminate", s = "buffer", l = "query";
            return{restrict: "E", template: '<div class="_md-container"><div class="_md-dashed"></div><div class="_md-bar _md-bar1"></div><div class="_md-bar _md-bar2"></div></div>', compile: r}
        }
        ...
        function e(e, n, o, r) {
            function i(i, a, d, c) {
                ...
                m.init(u), i.mouseActive = !1, a.attr({role: "radiogroup", tabIndex: a.attr("tabindex") || "0"}).on("keydown", l).on("mousedown", function (e) {
            ...
            return a.prototype = d(), {restrict: "E", controller: ["$element", a], require: ["mdRadioGroup", "?ngModel"], link: {pre: i}}
        }
        ...
        function n(e, t, n) {
            function o(o, i, a, d) {
                ...
                function m(n, o) {
                    ...
                    o.ariaId = r(), n.attr({id: o.ariaId, role: "radio", "aria-checked": "false"}), e.expectWithText(n, "aria-label")
                }
            ...
            var r = "md-checked";
            return{restrict: "E", require: "^mdRadioGroup", transclude: !0, template: '<div class="_md-container" md-ink-ripple md-ink-ripple-checkbox><div class="_md-off"></div><div class="_md-on"></div></div><div ng-transclude class="_md-label"></div>', link: o}
        }
        ...
        function e(e, o, r, i, a, d) {
            function c(a, c) {
                ...
                if (s.append('<span class="_md-select-icon" aria-hidden="true"></span>'), s.addClass("_md-select-value"), s[0].hasAttribute("id") || s.attr("id", "select_value_label_" + o.nextUid()), a.find("md-content").length || a.append(t.element("<md-content>").append(a.contents())), c.mdOnOpen && (a.find("md-content").prepend(t.element('<div> <md-progress-circular md-mode="{{progressMode}}" ng-hide="$$loadingAsyncDone" md-diameter="25px"></md-progress-circular></div>')), a.find("md-option").attr("ng-show", "$$loadingAsyncDone")), c.name) {
                    var l = t.element('<select class="_md-visually-hidden">');
                ...
                var u = o.parseAttributeBoolean(c.multiple), p = u ? "multiple" : "", h = '<div class="_md-select-menu-container" aria-hidden="true"><md-select-menu {0}>{1}</md-select-menu></div>';
                return h = o.supplant(h, [p, a.html()]), a.empty().append(s), a.append(h), c.tabindex || c.$set("tabindex", 0), function (a, c, s, l) {
                    function m() {
                        var e = c.attr("aria-label") || c.attr("placeholder");
                        !e && y && y.label && (e = y.label.text()), $ = e, i.expect(c, "aria-label", e)
                    }

                    function p() {
                        x && (S = S || x.find("md-select-menu").controller("mdSelectMenu"), C.setLabelText(S.selectedLabels()))
                    }

                    function h() {
                        if ($) {
                            var e = S.selectedLabels({mode: "aria"});
                            c.attr("aria-label", e.length ? $ + ": " + e : $)
                        }
                    }

                    function f() {
                        y && y.setHasValue(S.selectedLabels().length > 0 || (c[0].validity || {}).badInput)
                    }

                    function g() {
                        if (x = t.element(c[0].querySelector("._md-select-menu-container")), N = a, s.mdContainerClass) {
                            var e = x[0].getAttribute("class") + " " + s.mdContainerClass;
                            x[0].setAttribute("class", e)
                        }
                        S = x.find("md-select-menu").controller("mdSelectMenu"), S.init(A, s.ngModel), c.on("$destroy", function () {
                            x.remove()
                        })
                    }
                    ...
                    function b(e) {
                        var n = [32, 13, 38, 40];
                        if (-1 != n.indexOf(e.keyCode))e.preventDefault(), v(e); else if (e.keyCode <= 90 && e.keyCode >= 31) {
                            e.preventDefault();
                            var o = S.optNodeForKeyboardSearch(e);
                            if (!o)return;
                            var r = t.element(o).controller("mdOption");
                            S.isMultiple || S.deselect(Object.keys(S.selected)[0]), S.select(r.hashKey, r.value), S.refreshViewValue()
                        }
                    }

                    function v() {
                        N.isOpen = !0, c.attr("aria-expanded", "true"), e.show({scope: N, preserveScope: !0, skipCompile: !0, element: x, target: c[0], selectCtrl: C, preserveElement: !0, hasBackdrop: !0, loadingAsync: s.mdOnOpen ? a.$eval(s.mdOnOpen) || !0 : !1})["finally"](function () {
                            N.isOpen = !1, c.focus(), c.attr("aria-expanded", "false"), A.$setTouched()
                        })
                    }

                    var E, $, M = !0, y = l[0], C = l[1], A = l[2], k = l[3], T = c.find("md-select-value"), w = t.isDefined(s.readonly);
                    if (y) {
                        var _ = y.isErrorGetter || function () {
                            return A.$invalid && A.$touched
                        };
                        if (y.input)throw new Error("<md-input-container> can only have *one* child <input>, <textarea> or <select> element!");
                        y.input = c, y.label || i.expect(c, "aria-label", c.attr("placeholder")), a.$watch(_, y.setInvalid)
                    }
                    var x, N, S;
                    if (g(), r(c), s.name && k) {
                    ...
                    k && t.isDefined(s.multiple) && o.nextTick(function () {
                    ...
                    A.$render = function () {
                        D(), p(), h(), f()
                    }, s.$observe("placeholder", A.$render), C.setLabelText = function (e) {
                        if (C.setIsPlaceholder(!e), s.mdSelectedText)e = d(s.mdSelectedText)(a); else {
                            var t = s.placeholder || (y && y.label ? y.label.text() : "");
                            e = e || t || ""
                        }
                        var n = T.children().eq(0);
                        n.html(e)
                    }, C.setIsPlaceholder = function (e) {
                        e ? (T.addClass("_md-select-placeholder"), y && y.label && y.label.addClass("_md-placeholder")) : (T.removeClass("_md-select-placeholder"), y && y.label && y.label.removeClass("_md-placeholder"))
                    }, w || (c.on("focus", function (e) {
                        y && y.element.hasClass("md-input-has-value") && y.setFocused(!0)
                    }), c.on("blur", function (e) {
                        M && (M = !1, N.isOpen && e.stopImmediatePropagation()), N.isOpen || (y && y.setFocused(!1), f())
                    })), C.triggerClose = function () {
                        d(s.mdOnClose)(a)
                    }, a.$$postDigest(function () {
                        m(), p(), h()
                    }), a.$watch(S.selectedLabels, p);
                    var I;
                    s.$observe("ngMultiple", function (e) {
                        ...
                        I = a.$watch(function () {
                            ...
                            e === n && t === n || (e ? c.attr("multiple", "multiple") : c.removeAttr("multiple"), c.attr("aria-multiselectable", e ? "true" : "false"), x && (S.setMultiple(e), D = A.$render, A.$render = function () {
                                D(), p(), h(), f()
                            }, A.$render()))
                        })
                    }), s.$observe("disabled", function (e) {
                        t.isString(e) && (e = !0), E !== n && E === e || (E = e, e ? c.attr({"aria-disabled": "true"}).removeAttr("tabindex").off("click", v).off("keydown", b) : c.attr({tabindex: s.tabindex, "aria-disabled": "false"}).on("click", v).on("keydown", b))
                    }), s.hasOwnProperty("disabled") || s.hasOwnProperty("ngDisabled") || (c.attr({"aria-disabled": "false"}), c.on("click", v), c.on("keydown", b));
                    var O = {role: "listbox", "aria-expanded": "false", "aria-multiselectable": u && !s.ngMultiple ? "true" : "false"};
                    c[0].hasAttribute("id") || (O.id = "select_" + o.nextUid());
                    var R = "select_container_" + o.nextUid();
                    x.attr("id", R), O["aria-owns"] = R, c.attr(O), a.$on("$destroy", function () {
        ...
        function o(e, o, r) {
            ...
            return a.$inject = ["$scope", "$attrs", "$element"], {restrict: "E", require: ["mdSelectMenu"], scope: !0, controller: a, link: {pre: i}}
        }

        function r(e, n) {
            function o(e, n) {
                return e.append(t.element('<div class="_md-text">').append(e.contents())), e.attr("tabindex", n.tabindex || "0"), r
            }

            function r(o, r, i, a) {
                function d(e, t, n) {
                    if (!m.hashGetter)return void(n || o.$$postDigest(function () {
                        d(e, t, !0)
                    }));
                    var r = m.hashGetter(t, o), i = m.hashGetter(e, o);
                    l.hashKey = i, l.value = e, m.removeOption(r, l), m.addOption(i, l)
                }
                ...
                var l = a[0], m = a[1];
                m.isMultiple && (r.attr("md-checkbox-enabled", ""), r.prepend(s.clone())), t.isDefined(i.ngValue) ? o.$watch(i.ngValue, d) : t.isDefined(i.value) ? d(i.value) : o.$watch(function () {
                    return r.text().trim()
            ...
            return i.$inject = ["$element"], {restrict: "E", require: ["mdOption", "^^mdSelectMenu"], controller: i, compile: o}
        }

        function i() {
            function e(e, n) {
                var o = e.find("label");
                o.length || (o = t.element("<label>"), e.prepend(o)), o.addClass("_md-container-ignore"), n.label && o.text(n.label)
            }
        ...
        function a(e) {
            function o(e, o, s, l, m, u, p, h, f) {
                function g(e, t, n) {
                    function o() {
                        return p(t, {addClass: "_md-leave"}).start()
                    }

                    function r() {
                        t.removeClass("_md-active"), t.attr("aria-hidden", "true"), t[0].style.display = "none", v(n), !n.$destroy && n.restoreFocus && n.target.focus()
                    }
                ...
                function b(r, i, a) {
                    function d(e, t, n) {
                        return n.parent.append(t), m(function (e, n) {
                            try {
                                p(t, {removeClass: "_md-leave", duration: 0}).start().then(c).then(e)
                            } catch (o) {
                                n(o)
                            }
                        })
                    ...
                    function c() {
                        return m(function (e) {
                            ...
                            var t = E(r, i, a);
                            t.container.element.css(M.toCss(t.container.styles)), t.dropDown.element.css(M.toCss(t.dropDown.styles)), u(function () {
                                i.addClass("_md-active"), t.dropDown.element.css(M.toCss({transform: ""})), b(a.focusedNode), e()
                            })
                        })
                    }

                    function g(e, t, n) {
                        return n.disableParentScroll && !s.getClosest(n.target, "MD-DIALOG") ? n.restoreScroll = s.disableScrollAround(n.element, n.parent) : n.disableParentScroll = !1, n.hasBackdrop && (n.backdrop = s.createBackdrop(e, "_md-select-backdrop _md-click-catcher"), h.enter(n.backdrop, f[0].body, null, {duration: 0})), function () {
                    ...
                    function v(e, n) {
                        ...
                        if (!n.target)throw new Error(s.supplant($, [n.target]));
                        t.extend(n, {isRemoved: !1, target: t.element(n.target), parent: t.element(n.parent), selectEl: o, contentEl: i.find("md-content"), optionNodes: o[0].getElementsByTagName("md-option")})
                    }
                    ...
                    function A() {
                        ...
                        if (!a.isRemoved) {
                            ...
                            return i.addClass("_md-clickable"), a.backdrop && a.backdrop.on("click", t), u.on("keydown", r), u.on("click", m), function () {
                                a.backdrop && a.backdrop.off("click", t), u.off("keydown", r), u.off("click", m), i.removeClass("_md-clickable"), a.isRemoved = !0
                            }
                        }
                    }

                    return C(), v(r, a), a.hideBackdrop = g(r, i, a), d(r, i, a).then(function (e) {
                ...
                function E(e, n, o) {
                    var m, u = n[0], p = o.target[0].children[0], h = f[0].body, g = o.selectEl[0], b = o.contentEl[0], v = h.getBoundingClientRect(), E = p.getBoundingClientRect(), $ = !1, M = {left: v.left + d, top: d, bottom: v.height - d, right: v.width - d - (s.floatingScrollbars() ? 16 : 0)}, y = {top: E.top - M.top, left: E.left - M.left, right: M.right - (E.left + E.width), bottom: M.bottom - (E.top + E.height)}, C = v.width - 2 * d, A = g.querySelector("md-option[selected]"), k = g.getElementsByTagName("md-option"), T = g.getElementsByTagName("md-optgroup"), w = c(n, b), _ = r(o.loadingAsync);
                    m = _ ? b.firstElementChild || b : A ? A : T.length ? T[0] : k.length ? k[0] : b.firstElementChild || b, b.offsetWidth > C ? b.style["max-width"] = C + "px" : b.style.maxWidth = null, $ && (b.style["min-width"] = E.width + "px"), w && g.classList.add("_md-overflow");
                    var x = m;
                    "MD-OPTGROUP" === (x.tagName || "").toUpperCase() && (x = k[0] || b.firstElementChild || b, m = x), o.focusedNode = x, u.style.display = "block";
                    var N = g.getBoundingClientRect(), S = a(m);
                    if (m) {
                        var H = l.getComputedStyle(m);
                        S.paddingLeft = parseInt(H.paddingLeft, 10) || 0, S.paddingRight = parseInt(H.paddingRight, 10) || 0
                    }
                    if (w) {
                        var D = b.offsetHeight / 2;
                        b.scrollTop = S.top + S.height / 2 - D, y.top < D ? b.scrollTop = Math.min(S.top, b.scrollTop + D - y.top) : y.bottom < D && (b.scrollTop = Math.max(S.top + S.height - N.height, b.scrollTop - D + y.bottom))
                    }
                    var I, O, R, L;
                    $ ? (I = E.left, O = E.top + E.height, R = "50% 0", O + N.height > M.bottom && (O = E.top - N.height, R = "50% 100%")) : (I = E.left + S.left - S.paddingLeft + 2, O = Math.floor(E.top + E.height / 2 - S.height / 2 - S.top + b.scrollTop) + 2, R = S.left + E.width / 2 + "px " + (S.top + S.height / 2 - b.scrollTop) + "px 0px", L = Math.min(E.width + S.paddingLeft + S.paddingRight, C));
                    var P = u.getBoundingClientRect(), F = Math.round(100 * Math.min(E.width / N.width, 1)) / 100, B = Math.round(100 * Math.min(E.height / N.height, 1)) / 100;
                    return{container: {element: t.element(u), styles: {left: Math.floor(i(M.left, I, M.right - P.width)), top: Math.floor(i(M.top, O, M.bottom - P.height)), "min-width": L}}, dropDown: {element: t.element(g), styles: {transformOrigin: R, transform: o.alreadyOpen ? "" : s.supplant("scale({0},{1})", [F, B])}}}
                }

                var $ = "$mdSelect.show() expected a target element in options.target but got '{0}'!", M = s.dom.animator;
            ...
            return o.$inject = ["$mdSelect", "$mdConstant", "$mdUtil", "$window", "$q", "$$rAF", "$animateCss", "$animate", "$document"], e("$mdSelect").setDefaults({methods: ["target"], options: o})
        }

        var d = 8, c = 0, s = t.element('<div class="_md-container"><div class="_md-icon"></div></div>');
        ...
        function e(e, t) {
            return["$mdUtil", function (n) {
                return{restrict: "A", multiElement: !0, link: function (o, r, i) {
        ...
        function e(e, n) {
            return function (o) {
                ...
                return d || e.notFoundError(o), i = {isOpen: function () {
                    return d && d.isOpen()
        ...
        function r(e, o, r, i, a, d, c, s, l, m) {
            function u(d, u, p, h) {
                function f(e, t) {
                    d.isLockedOpen = e, e === t ? u.toggleClass("_md-locked-open", !!e) : a[e ? "addClass" : "removeClass"](u, "_md-locked-open"), y && y.toggleClass("_md-locked-open", !!e)
                }

                function g(e) {
                    var t = o.findFocusTarget(u) || o.findFocusTarget(u, "[md-sidenav-focus]") || u, n = u.parent();
                    return n[e ? "on" : "off"]("keydown", E), y && y[e ? "on" : "off"]("click", $), e && (C = m[0].activeElement), b(e), A = l.all([e && y ? a.enter(y, n) : y ? a.leave(y) : l.when(!0), a[e ? "removeClass" : "addClass"](u, "_md-closed")]).then(function () {
                        d.isOpen && t && t.focus()
                    })
                }
                ...
                function b(e) {
                    var o = u.parent();
                    e && !M ? (M = o.css("overflow"), o.css("overflow", "hidden")) : t.isDefined(M) && (o.css("overflow", M), M = n)
                }
                ...
                var M, y, C = null, A = l.when(!0), k = c(p.mdIsLockedOpen), T = function () {
                    return k(d.$parent, {$media: function (t) {
                        return s.warn("$media is deprecated for is-locked-open. Use $mdMedia instead."), e(t)
                    }, $mdMedia: e})
                };
                t.isDefined(p.mdDisableBackdrop) || (y = o.createBackdrop(d, "_md-sidenav-backdrop md-opaque ng-enter")), i(u), y && i.inherit(y, u), u.on("$destroy", function () {
                    y && y.remove(), h.destroy()
                }), d.$on("$destroy", function () {
                    y && y.remove()
                }), d.$watch(T, f), d.$watch("isOpen", g), h.$toggleOpen = v
            }

            return{restrict: "E", scope: {isOpen: "=?mdIsOpen"}, controller: "$mdSidenavController", compile: function (e) {
                return e.addClass("_md-closed"), e.attr("tabIndex", "-1"), u
            }}
        }
        ...
        function e(e, o, r, i, a) {
            function d(e) {
                ...
                function d(e) {
                    ...
                    var o = i.floatingScrollbars() ? "0" : n;
                    i.bidi(e.clone, "margin-left", e.left, o), i.bidi(e.clone, "margin-right", o, e.right)
                }

                function c() {
                    var e = p.prop("scrollTop"), t = e > (c.prevScrollTop || 0);
                ...
                function u(e, t) {
                    e && (null === t || t === n ? e.translateY && (e.translateY = null, e.clone.css(o.CSS.TRANSFORM, "")) : (e.translateY = t, i.bidi(e.clone, o.CSS.TRANSFORM, "translate3d(" + e.left + "px," + t + "px,0)", "translateY(" + t + "px)")))
                }

                var p = e.$element, h = r.throttle(a);
                s(p), p.on("$scrollstart", h), p.on("$scroll", c);
                var f;
            ...
            function c(n) {
                ...
                for (var i = ["sticky", "-webkit-sticky"], a = 0; a < i.length; ++a)if (r.css({position: i[a], top: 0, "z-index": 2}), r.css("position") == i[a]) {
                    o = i[a];
                    break
                }
                return r.remove(), o
            ...
            return function (e, t, n) {
                ...
                if (o)if (l)t.css({position: l, top: 0, "z-index": 2}); else {
                    var r = o.$element.data("$$sticky");
                    r || (r = d(o), o.$element.data("$$sticky", r));
                    var i = n || a(t.clone())(e), c = r.add(t, i);
                    e.$on("$destroy", c)
                }
            }
        }

        t.module("material.components.sticky", ["material.core", "material.components.content"]).factory("$mdSticky", e), e.$inject = ["$document", "$mdConstant", "$$rAF", "$mdUtil", "$compile"]
    }(), function () {
        function e() {
            return{controller: function () {
                ...
                if (o) {
                    var r = o.attr("md-vertical");
                    return r !== n && e.attr("md-vertical", ""), o.attr("flex") || o.attr("flex", ""), function (e, n, o, r) {
                        function i(e) {
                            n.children().attr("disabled", e), n.find("input").attr("disabled", e)
                        }

                        var a = t.noop;
                        o.disabled ? i(!0) : o.ngDisabled && (a = e.$watch(o.ngDisabled, function (e) {
                            i(e)
                        })), e.$on("$destroy", function () {
                            a()
                        });
                        var d;
                        r.fitInputWidthToTextLength = function (e) {
                            var t = n.find("md-input-container"), o = getComputedStyle(t[0]), r = parseInt(o["min-width"]), i = 2 * parseInt(o.padding);
                            d = d || parseInt(o["max-width"]);
                            var a = Math.max(d, r + i + r / 2 * e);
                            t.css("max-width", a + "px")
                        }
                    }
                }
            }}
        ...
        function o(e, n, o, r, i, a, d, c, s, l) {
            function m(e, n) {
                var r = t.element(e[0].getElementsByClassName("_md-slider-wrapper")), i = n.tabindex || 0;
                return r.attr("tabindex", i), (n.disabled || n.ngDisabled) && r.attr("tabindex", -1), r.attr("role", "slider"), o.expect(e, "aria-label"), u
            }
            ...
            function u(o, m, u, p) {
                ...
                function f(e) {
                    de = parseFloat(e), m.attr("aria-valuemin", e), h()
                }
                ...
                function $() {
                    if (re && !Y() && !t.isUndefined(se)) {
                        if (0 >= se) {
                            var e = "Slider step value must be greater than zero when in discrete mode";
                            throw s.error(e), new Error(e)
                        }
                        var o = Math.floor((ce - de) / se);
                        me || (me = t.element("<canvas>").css("position", "absolute"), J.append(me), ue = me[0].getContext("2d"));
                        var r = C();
                        !r || r.height || r.width || (y(), r = pe), me[0].width = r.width, me[0].height = r.height;
                        for (var i, a = 0; o >= a; a++) {
                            var d = n.getComputedStyle(J[0]);
                            ue.fillStyle = d.color || "black", i = Math.floor((oe ? r.height : r.width) * (a / o)), ue.fillRect(oe ? 0 : i - 1, oe ? i - 1 : 0, oe ? r.width : 2, oe ? 2 : r.height)
                        }
                    }
                }
                ...
                function M() {
                    if (me && ue) {
                        var e = C();
                        ue.clearRect(0, 0, e.width, e.height)
                    }
                }
                ...
                function A(e) {
                    if (!Y()) {
                        var t;
                        (oe ? e.keyCode === i.KEY_CODE.DOWN_ARROW : e.keyCode === i.KEY_CODE.LEFT_ARROW) ? t = -se : (oe ? e.keyCode === i.KEY_CODE.UP_ARROW : e.keyCode === i.KEY_CODE.RIGHT_ARROW) && (t = se), t && ((e.metaKey || e.ctrlKey || e.altKey) && (t *= 4), e.preventDefault(), e.stopPropagation(), o.$evalAsync(function () {
                            _(V.$viewValue + t)
                        }))
                    }
                }
                ...
                function w() {
                    ee.removeClass("md-focused"), m.removeClass("_md-active"), M()
                }

                function _(e) {
                    V.$setViewValue(N(S(e)))
                }

                function x() {
                    isNaN(V.$viewValue) && (V.$viewValue = V.$modelValue), V.$viewValue = N(V.$viewValue);
                    var e = (V.$viewValue - de) / (ce - de);
                    o.modelValue = V.$viewValue, m.attr("aria-valuenow", V.$viewValue), H(e), G.text(V.$viewValue)
                }

                function N(e, n, o) {
                    return t.isNumber(e) ? (n = t.isNumber(n) ? n : de, o = t.isNumber(o) ? o : ce, Math.max(n, Math.min(o, e))) : void 0
                }

                function S(e) {
                    if (t.isNumber(e)) {
                        var n = Math.round((e - de) / se) * se + de;
                        return n = Math.round(n * Math.pow(10, le)) / Math.pow(10, le), W && W.fitInputWidthToTextLength && r.debounce(function () {
                            W.fitInputWidthToTextLength(n.toString().length)
                        }, 100)(), n
                    }
                }
                ...
                function H(e) {
                    e = U(e);
                    var t = 100 * e + "%";
                    X.css(oe ? "bottom" : "left", t), Z.css(oe ? "height" : "width", t), m.toggleClass("_md-min", 0 === e), m.toggleClass("_md-max", 1 === e)
                }

                function D(e) {
                    if (!Y()) {
                        m.addClass("_md-active"), m[0].focus(), y();
                        var t = q(z(oe ? e.pointer.y : e.pointer.x)), n = N(S(t));
                        o.$apply(function () {
                            _(n), H(j(n))
                        })
                    }
                ...
                function O(e) {
                    Y() || (he = !0, e.stopPropagation(), m.addClass("_md-dragging"), P(e))
                }

                function R(e) {
                    he && (e.stopPropagation(), P(e))
                }
                ...
                function P(e) {
                    re ? B(oe ? e.pointer.y : e.pointer.x) : F(oe ? e.pointer.y : e.pointer.x)
                }
                ...
                function z(e) {
                    var t = oe ? pe.top : pe.left, n = oe ? pe.height : pe.width, o = (e - t) / n;
                    return Math.max(0, Math.min(1, oe ? 1 - o : o))
                }
                ...
                var ie = t.noop;
                u.ngDisabled && (ie = o.$parent.$watch(u.ngDisabled, E)), d.register(ee, "drag", {horizontal: !oe}), o.mouseActive = !1, ee.on("keydown", A).on("mousedown", k).on("focus", T).on("blur", w).on("$md.pressdown", D).on("$md.pressup", I).on("$md.dragstart", O).on("$md.drag", R).on("$md.dragend", L), setTimeout(h, 0);
                var ae = e.throttle(h);
                t.element(n).on("resize", ae), o.$on("$destroy", function () {
                    t.element(n).off("resize", ae)
                }), V.$render = x, V.$viewChangeListeners.push(x), V.$formatters.push(N), V.$formatters.push(S);
                var de, ce, se, le, me, ue, pe = {};
                y();
                var he = !1
            }

            return{scope: {}, require: ["?ngModel", "?^mdSliderContainer"], template: '<div class="_md-slider-wrapper"><div class="_md-slider-content"><div class="_md-track-container"><div class="_md-track"></div><div class="_md-track _md-track-fill"></div><div class="_md-track-ticks"></div></div><div class="_md-thumb-container"><div class="_md-thumb"></div><div class="_md-focus-thumb"></div><div class="_md-focus-ring"></div><div class="_md-sign"><span class="_md-thumb-text"></span></div><div class="_md-disabled-thumb"></div></div></div></div>', compile: m}
        }
        ...
        function e(e, n, o, r) {
            return{restrict: "E", replace: !0, transclude: !0, template: '<div class="md-subheader">  <div class="_md-subheader-inner">    <span class="_md-subheader-content"></span>  </div></div>', link: function (i, a, d, c, s) {
                function l(e) {
                    return t.element(e[0].querySelector("._md-subheader-content"))
                }
                ...
                s(i, function (e) {
                    ...
                    var o = '<div class="_md-subheader-wrapper">' + m + "</div>", d = n(o)(i);
        ...
        function e(e, n, o, r, i, a) {
            function d(e, d) {
                var s = c.compile(e, d);
                return e.addClass("_md-dragging"), function (e, d, c, l) {
                    function m(t) {
                        f && f(e) || (t.stopPropagation(), d.addClass("_md-dragging"), v = {width: g.prop("offsetWidth")})
                    }

                    function u(e) {
                        if (v) {
                            e.stopPropagation(), e.srcEvent && e.srcEvent.preventDefault();
                            var t = e.pointer.distanceX / v.width, n = l.$viewValue ? 1 + t : t;
                            n = Math.max(0, Math.min(1, n)), g.css(o.CSS.TRANSFORM, "translate3d(" + 100 * n + "%,0,0)"), v.translate = n
                        }
                    }

                    function p(e) {
                        if (v) {
                            e.stopPropagation(), d.removeClass("_md-dragging"), g.css(o.CSS.TRANSFORM, "");
                            var t = l.$viewValue ? v.translate > .5 : v.translate < .5;
                            t && h(!l.$viewValue), v = null
                        }
                    }
                    ...
                    var g = t.element(d[0].querySelector("._md-thumb-container")), b = t.element(d[0].querySelector("._md-container"));
                    i(function () {
                        d.removeClass("_md-dragging")
            ...
            var c = e[0];
            return{restrict: "E", priority: 210, transclude: !0, template: '<div class="_md-container"><div class="_md-bar"></div><div class="_md-thumb-container"><div class="_md-thumb" md-ink-ripple md-ink-ripple-checkbox></div></div></div><div ng-transclude class="_md-label"></div>', require: "?ngModel", compile: d}
        }
        ...
        function n(e) {
            ...
            function o(e, n, o, i) {
                function a(t, a, d) {
                    ...
                    return a = o.extractElementByName(a, "md-toast", !0), d.element = a, d.onSwipe = function (e, t) {
                        ...
                        "down" === i && -1 != d.position.indexOf("top") && !l || "up" === i && (-1 != d.position.indexOf("bottom") || l) || ("left" !== i && "right" !== i || !l) && (a.addClass("_md-" + r), o.nextTick(n.cancel))
                    }, d.openClass = c(d.position), d.parent.addClass(d.openClass), o.hasComputedStyle(d.parent, "position", "static") && d.parent.css("position", "relative"), a.on(s, d.onSwipe), a.addClass(l ? "_md-bottom" : d.position.split(" ").map(function (e) {
                        return"_md-" + e
                    }).join(" ")), d.parent && d.parent.addClass("_md-toast-animating"), e.enter(a, d.parent).then(function () {
                        d.parent && d.parent.removeClass("_md-toast-animating")
                    })
                }

                function d(t, n, r) {
                    return n.off(s, r.onSwipe), r.parent && r.parent.addClass("_md-toast-animating"), r.openClass && r.parent.removeClass(r.openClass), (1 == r.$destroy ? n.remove() : e.leave(n)).then(function () {
                        r.parent && r.parent.removeClass("_md-toast-animating"), o.hasComputedStyle(r.parent, "position", "static") && r.parent.css("position", "")
                    })
                }

                function c(e) {
                    return i("gt-xs") ? "_md-toast-open-" + (e.indexOf("top") > -1 ? "top" : "bottom") : "_md-toast-open-bottom"
                }

                var s = "$md.swipeleft $md.swiperight $md.swipeup $md.swipedown";
                return{onShow: a, onRemove: d, position: "bottom left", themable: !0, hideDelay: 3e3, autoWrap: !0, transformTemplate: function (e, n) {
                    var o = n.autoWrap && e && !/md-toast-content/g.test(e);
                    if (o) {
                        var r = document.createElement("md-template");
                        r.innerHTML = e;
                        for (var i = 0; i < r.children.length; i++)if ("MD-TOAST" === r.children[i].nodeName) {
                            var a = t.element('<div class="md-toast-content">');
                            a.append(r.children[i].children), r.children[i].appendChild(a[0])
                        }
                        return r.outerHTML
                    }
                    return e || ""
            ...
            var r, i = "ok", a = e("$mdToast").setDefaults({methods: ["position", "hideDelay", "capsule", "parent", "position"], options: o}).addPreset("simple", {argOption: "textContent", methods: ["textContent", "content", "action", "highlightAction", "highlightClass", "theme", "parent"], options: ["$mdToast", "$mdTheming", function (e, t) {
                return{template: '<md-toast md-theme="{{ toast.theme }}" ng-class="{\'md-capsule\': toast.capsule}">  <div class="md-toast-content">    <span flex class="md-toast-text" role="alert" aria-relevant="all" aria-atomic="true">      {{ toast.content }}    </span>    <md-button class="md-action" ng-if="toast.action" ng-click="toast.resolve()"         ng-class="highlightClasses">      {{ toast.action }}    </md-button>  </div></md-toast>', controller: ["$scope", function (t) {
                    var n = this;
                ...
                }], theme: t.defaultTheme(), controllerAs: "toast", bindToController: !0}
        ...
        function e(e, n, o, r, i) {
            ...
            return{template: "", restrict: "E", link: function (d, c, s) {
                function l() {
                    function r(e) {
                    ...
                    function l(e, t) {
                        t && c.parent()[0] === t.parent()[0] && (f && f.off("scroll", $), f = t, g = u())
                    }

                    function m(e) {
                        var t = e ? e.target.scrollTop : v;
                        M(), b = Math.min(h / E, Math.max(0, b + t - v)), c.css(n.CSS.TRANSFORM, a([-b * E])), f.css(n.CSS.TRANSFORM, a([(h - b) * E])), v = t, o.nextTick(function () {
                    ...
                    function u() {
                        return f ? (f.on("scroll", $), f.attr("scroll-shrink", "true"), e(p), function () {
                            f.off("scroll", $), f.attr("scroll-shrink", "false"), e(p)
                        }) : t.noop
                    }
                    ...
                    var h, f, g = t.noop, b = 0, v = 0, E = s.mdShrinkSpeedFactor || .5, $ = e.throttle(m), M = o.debounce(p, 5e3);
        ...
        function e() {
            return{controller: o, template: n, compile: function (e, t) {
        ...
        function r(e) {
            return{controller: i, priority: 1e3, require: ["mdVirtualRepeat", "^^mdVirtualRepeatContainer"], restrict: "A", terminal: !0, transclude: "element", compile: function (t, n) {
        ...
        function i(e, n, o, r, i, a, d, c) {
            this.$scope = e, this.$element = n, this.$attrs = o, this.$browser = r, this.$document = i, this.$rootScope = a, this.$$rAF = d, this.onDemand = c.parseAttributeBoolean(o.mdOnDemand), this.browserCheckUrlChange = r.$$checkUrlChange, this.newStartIndex = 0, this.newEndIndex = 0, this.newVisibleEnd = 0, this.startIndex = 0, this.endIndex = 0, this.itemSize = e.$eval(o.mdItemSize) || null, this.isFirstRender = !0, this.isVirtualRepeatUpdating_ = !1, this.itemsLength = 0, this.unwatchItemSize_ = t.noop, this.blocks = {}, this.pooledBlocks = []
        }
        ...
        o.$inject = ["$$rAF", "$mdUtil", "$parse", "$rootScope", "$window", "$scope", "$element", "$attrs"], o.prototype.register = function (e) {
            ...
            if (this.sizer.innerHTML = "", d > e)this.sizer.style[t] = e + "px"; else {
                ...
                r.style[t] = "1533917px", r.style[n] = "1px";
            ...
            if (!(o === this.scrollOffset || o > this.scrollSize - this.size)) {
                var r = this.repeater.getItemSize();
                if (r) {
                    var i = Math.max(0, Math.floor(o / r) - c), a = (this.isHorizontal() ? "translateX(" : "translateY(") + (!this.isHorizontal() || n ? i * r : -(i * r)) + "px)";
                    if (this.scrollOffset = o, this.offsetter.style.webkitTransform = a, this.offsetter.style.transform = a, this.bindTopIndex) {
                        var d = Math.floor(o / r);
        ...
        }, r.$inject = ["$parse"], i.$inject = ["$scope", "$element", "$attrs", "$browser", "$document", "$rootScope", "$$rAF", "$mdUtil"], i.Block, i.prototype.link_ = function (e, n, o, r, i) {
        ...
        function e(e, n, o, r, i, a, d, c, s) {
            function l(d, l, p) {
                ...
                function f() {
                    ...
                    T.css("transform-origin", e)
                }

                function g() {
                    d.$on("$destroy", function () {
                        d.visible = !1, l.remove(), t.element(n).off("resize", _)
                ...
                function b() {
                    k.attr("aria-label") || k.text().trim() || k.attr("aria-label", l.text().trim())
                }
                ...
                function E() {
                    ...
                    if (k[0] && "MutationObserver"in n) {
                        var a = new MutationObserver(function (e) {
                            e.forEach(function (e) {
                                "disabled" === e.attributeName && k[0].disabled && ($(!1), d.$digest())
                            })
                        });
                        a.observe(k[0], {attributes: !0})
                    }
                    var c = function () {
                        s = document.activeElement === k[0]
                    }, s = !1;
                    i.on("blur", c), i.on("resize", _), document.addEventListener("scroll", e, !0), d.$on("$destroy", function () {
                        i.off("blur", c), i.off("resize", _), document.removeEventListener("scroll", e, !0), a && a.disconnect()
                    });
                    var l = function (e) {
                        return"focus" === e.type && s ? void(s = !1) : (k.on("blur mouseleave touchend touchcancel", m), void $(!0))
                    }, m = function () {
                        var e = d.hasOwnProperty("autohide") ? d.autohide : p.hasOwnProperty("mdAutohide");
                        (e || o || r[0].activeElement !== k[0]) && (k.off("blur mouseleave touchend touchcancel", m), k.triggerHandler("blur"), $(!1)), o = !1
                    };
                    k.on("mousedown", function () {
                        o = !0
                    }), k.on("focus mouseenter touchstart", l)
                }

                function $(t) {
                    $.value = !!t, $.queued || (t ? ($.queued = !0, e(function () {
                        d.visible = $.value, $.queued = !1
                ...
                function M() {
                    return w.append(l), i.hasComputedStyle(l, "display", "none") ? (d.visible = !1, void l.detach()) : (C(), void t.forEach([l, T], function (e) {
                        c.addClass(e, "_md-show")
                    }))
                }

                function y() {
                    var e = [];
                    t.forEach([l, T], function (t) {
                        t.parent() && t.hasClass("_md-show") && e.push(c.removeClass(t, "_md-show"))
                ...
                function A() {
                    function e(e) {
                        ...
                        return t.left = Math.min(t.left, w.prop("scrollWidth") - n.width - u), t.left = Math.max(t.left, u), t.top = Math.min(t.top, w.prop("scrollHeight") - n.height - u), t.top = Math.max(t.top, u), t
                    }

                    function t(e) {
                        return"left" === e ? {left: o.left - n.width - u, top: o.top + o.height / 2 - n.height / 2} : "right" === e ? {left: o.left + o.width + u, top: o.top + o.height / 2 - n.height / 2} : "top" === e ? {left: o.left + o.width / 2 - n.width / 2, top: o.top - n.height - u} : {left: o.left + o.width / 2 - n.width / 2, top: o.top + o.height + u}
                    }

                    var n = i.offsetRect(l, w), o = i.offsetRect(k, w), r = t(d.direction), a = l.prop("offsetParent");
                    d.direction ? r = e(r) : a && r.top > a.scrollHeight - n.height - u && (r = e(t("top"))), l.css({left: r.left + "px", top: r.top + "px"})
                }

                a(l);
                var k = i.getParentWithPointerEvents(l), T = t.element(l[0].getElementsByClassName("_md-content")[0]), w = t.element(document.body), _ = o.throttle(function () {
                    C()
                });
                c.pin && c.pin(l, k), h(), v(), E(), f(), g(), b()
            }

            var m = 0, u = 8;
            return{restrict: "E", transclude: !0, priority: 210, template: '<div class="_md-content" ng-transclude></div>', scope: {delay: "=?mdDelay", visible: "=?mdVisible", autohide: "=?mdAutohide", direction: "@?mdDirection"}, link: l}
        }
        ...
        function e(e, o, d, c, s, l, m, u, p, h) {
            function f() {
                d.initOptionalProperties(e, p, {searchText: null, selectedItem: null}), s(o), E(), d.nextTick(function () {
                    M(), b(), v(), o.on("focus", v)
                })
            }
            ...
            function g() {
                ...
                function n() {
                    var e = ue.scrollContainer.getBoundingClientRect(), t = {};
                    e.right > m.right - i && (t.left = s.right - e.width + "px"), ue.$.scrollContainer.css(t)
                }

                if (!ue)return d.nextTick(g, !1, e);
                var c, s = ue.wrap.getBoundingClientRect(), l = ue.snap.getBoundingClientRect(), m = ue.root.getBoundingClientRect(), u = l.bottom - m.top, h = m.bottom - l.top, f = s.left - m.left, b = s.width, v = t();
            ...
            function b() {
                ue.$.root.length && (s(ue.$.scrollContainer), ue.$.scrollContainer.detach(), ue.$.root.append(ue.$.scrollContainer), m.pin && m.pin(ue.$.scrollContainer, u))
            }

            function v() {
                e.autofocus && ue.input.focus()
            }

            function E() {
                var n = parseInt(e.delay, 10) || 0;
                p.$observe("disabled", function (e) {
                    se.isDisabled = d.parseAttributeBoolean(e, !1)
                }), p.$observe("required", function (e) {
                    se.isRequired = d.parseAttributeBoolean(e, !1)
                }), p.$observe("readonly", function (e) {
                    se.isReadonly = d.parseAttributeBoolean(e, !1)
                }), e.$watch("searchText", n ? d.debounce(I, n) : I), e.$watch("selectedItem", _), t.element(l).on("resize", g), e.$on("$destroy", $)
            }

            function $() {
                if (se.hidden || d.enableScrolling(), t.element(l).off("resize", g), ue) {
            ...
            function M() {
                ue = {main: o[0], scrollContainer: o[0].getElementsByClassName("md-virtual-repeat-container")[0], scroller: o[0].getElementsByClassName("md-virtual-repeat-scroller")[0], ul: o.find("ul")[0], input: o.find("input")[0], wrap: o.find("md-autocomplete-wrap")[0], root: document.body}, ue.li = ue.ul.getElementsByTagName("li"), ue.snap = y(), ue.$ = C(ue)
            }
            ...
            function A(t, n) {
                !t && n ? (g(), ue && d.nextTick(function () {
                    d.disableScrollAround(ue.ul)
            ...
            function T() {
                ge || ue.input.focus(), he = !1, se.hidden = j()
            }
            ...
            function I(t, n) {
                se.index = z(), t !== n && B(e.selectedItem).then(function (o) {
                    t !== o && (e.selectedItem = null, t !== n && N(), X() ? de() : (se.matches = [], q(!1), te()))
                })
            }
            ...
            function R(e) {
                e && (he = !1, ge = !1), ue.input.blur()
            }

            function L() {
                ge = !0, t.isString(e.searchText) || (e.searchText = ""), se.hidden = j(), se.hidden || de()
            }
            ...
            function P(e) {
                switch (e.keyCode) {
                    case c.KEY_CODE.DOWN_ARROW:
                        ...
                        e.stopPropagation(), e.preventDefault(), se.index = Math.min(se.index + 1, se.matches.length - 1), oe(), te();
                        break;
                    case c.KEY_CODE.UP_ARROW:
                        if (se.loading)return;
                        e.stopPropagation(), e.preventDefault(), se.index = se.index < 0 ? se.matches.length - 1 : Math.max(0, se.index - 1), oe(), te();
                        break;
                    case c.KEY_CODE.TAB:
                        if (T(), se.hidden || se.loading || se.index < 0 || se.matches.length < 1)return;
                        Z(se.index);
                        break;
                    case c.KEY_CODE.ENTER:
                        if (se.hidden || se.loading || se.index < 0 || se.matches.length < 1)return;
                        if (Y())return;
                        e.stopPropagation(), e.preventDefault(), Z(se.index);
                        break;
            ...
            function q(e) {
                se.loading != e && (se.loading = e), se.hidden = j()
            }

            function j() {
                return se.loading && !W() ? !0 : Y() ? !0 : ge ? !V() : !0
            }
            ...
            function W() {
                return!!se.matches.length
            }

            function Y() {
                return!!se.scope.selectedItem
            }
            ...
            function Q(e, t, n) {
                Object.defineProperty(se, e, {get: function () {
                    return n
                }, set: function (e) {
                    var o = n;
                    n = e, t(e, o)
            ...
            function Z(t) {
                d.nextTick(function () {
                    B(se.matches[t]).then(function (e) {
                        var t = ue.$.input.controller("ngModel");
            ...
            function J() {
                q(!0), se.index = 0, se.matches = [], e.searchText = "";
                var t = document.createEvent("CustomEvent");
                t.initCustomEvent("input", !0, !0, {value: e.searchText}), ue.input.dispatchEvent(t), ue.input.focus()
            }

            function ee(n) {
                function o(t) {
                    t && (t = h.when(t), ve++, q(!0), d.nextTick(function () {
                ...
                function r(t) {
                    pe[a] = t, (n || "") === (e.searchText || "") && (se.matches = t, se.hidden = j(), se.loading && q(!1), e.selectOnMatch && ce(), te(), g())
                }

                var i = e.$parent.$eval(me), a = n.toLowerCase(), c = t.isArray(i), s = !!i.then;
                c ? r(i) : s && o(i)
            }
            ...
            function ne() {
                if (be === se.matches.length)return"";
                switch (be = se.matches.length, se.matches.length) {
                    case 0:
            ...
            function oe() {
                if (ue.li[0]) {
                    var e = ue.li[0].offsetHeight, t = e * se.index, n = t + e, o = ue.scroller.clientHeight, r = ue.scroller.scrollTop;
                    r > t ? ie(t) : n > r + o && ie(n - o)
                }
            }
            ...
            function ie(e) {
                ue.$.scrollContainer.controller("mdVirtualRepeatContainer").scrollTo(e)
            }

            function ae() {
                var e = (se.scope.searchText || "").length;
                return se.hasNotFound && !W() && (!se.loading || re()) && e >= F() && (ge || he) && !Y()
            }

            function de() {
                var t = e.searchText || "", n = t.toLowerCase();
                !e.noCache && pe[n] ? (se.matches = pe[n], te()) : ee(t), se.hidden = j()
            }

            function ce() {
                var t = e.searchText, n = se.matches, o = n[0];
            ...
            var se = this, le = e.itemsExpr.split(/ in /i), me = le[1], ue = null, pe = {}, he = !1, fe = [], ge = !1, be = 0, ve = 0;
            return Q("hidden", A, !0), se.scope = e, se.parent = e.$parent, se.itemName = le[0], se.matches = [], se.loading = !1, se.hidden = !0, se.index = null, se.messages = [], se.id = d.nextUid(), se.isDisabled = null, se.isRequired = null, se.isReadonly = null, se.hasNotFound = !1, se.keydown = P, se.blur = O, se.focus = L, se.clear = J, se.select = Z, se.listEnter = k, se.listLeave = T, se.mouseUp = w, se.getCurrentDisplayValue = G, se.registerSelectedItemWatcher = H, se.unregisterSelectedItemWatcher = D, se.notFoundVisible = ae, se.loadingIsVisible = K, f()
        }
        ...
        function e(e, t) {
            return{terminal: !0, controller: "MdHighlightCtrl", compile: function (n, o) {
        ...
        function o(e, t, o, r, i) {
            this.$scope = e, this.$element = t, this.$mdConstant = o, this.$timeout = r, this.$mdUtil = i, this.isEditting = !1, this.parentController = n, this.enableChipEdit = !1
        }
        ...
        t.module("material.components.chips").controller("MdChipCtrl", o), o.$inject = ["$scope", "$element", "$mdConstant", "$timeout", "$mdUtil"], o.prototype.init = function (e) {
            ...
            var e = this.$element[0].getElementsByClassName("_md-chip-content");
        ...
        function e(e, o) {
            function r(n, r) {
                return n.append(o.processTemplate(i)), function (n, o, r, i) {
                    var a = i.shift(), d = i.shift();
                    e(o), a && (d.init(a), t.element(o[0].querySelector("._md-chip-content")).on("blur", function () {
                        a.selectedChip = -1, a.$scope.$applyAsync()
                    }))
                }
            }

            var i = o.processTemplate(n);
            return{restrict: "E", require: ["^?mdChips", "mdChip"], compile: r, controller: "MdChipCtrl"}
        }

        t.module("material.components.chips").directive("mdChip", e);
        var n = '    <span ng-if="!$mdChipsCtrl.readonly" class="_md-visually-hidden">      {{$mdChipsCtrl.deleteHint}}    </span>';
        ...
        t.module("material.components.chips").controller("MdChipsCtrl", e), e.$inject = ["$scope", "$mdConstant", "$log", "$element", "$timeout", "$mdUtil"], e.prototype.inputKeydown = function (e) {
            ...
            if (!(null == e || this.items.indexOf(e) + 1)) {
                ...
                this.ngModelCtrl.$setDirty(), this.validateModel(), this.useOnAdd && this.onAdd && this.onAdd({$chip: e, $index: r})
            }
            ...
            this.ngModelCtrl.$setDirty(), this.validateModel(), t && t.length && this.useOnRemove && this.onRemove && this.onRemove({$chip: t[0], $index: e})
            ...
            this.$element[0].querySelector('md-chip[index="' + e + '"] ._md-chip-content').focus()
        ...
        function e(e, t, a, d, c) {
            function s(n, o) {
                ...
                var s = r("md-chips>md-chip-template"), l = r("md-chips>*[md-chip-remove]") || m.remove, u = s || m["default"], p = r("md-chips>md-autocomplete") || r("md-chips>input") || m.input, h = i.find("md-chip");
                return i[0].querySelector("md-chip-template>*[md-chip-remove]") && d.warn("invalid placement of md-chip-remove within md-chip-template."), function (n, r, i, d) {
                    ...
                    var f = d[0];
                    if (s && (f.enableChipEdit = !1), f.chipContentsTemplate = u, f.chipRemoveTemplate = l, f.chipInputTemplate = p, r.attr({"aria-hidden": !0, tabindex: -1}).on("focus", function () {
                        f.onFocus()
                    }), o.ngModel && (f.configureNgModel(r.controller("ngModel")), i.mdTransformChip && f.useTransformChipExpression(), i.mdOnAppend && f.useOnAppendExpression(), i.mdOnAdd && f.useOnAddExpression(), i.mdOnRemove && f.useOnRemoveExpression(), i.mdOnSelect && f.useOnSelectExpression(), p != m.input && n.$watch("$mdChipsCtrl.readonly", function (e) {
                        e || t.nextTick(function () {
                            0 === p.indexOf("<md-autocomplete") && f.configureAutocomplete(r.find("md-autocomplete").controller("mdAutocomplete")), f.configureUserInput(r.find("input"))
                        })
                    }), t.nextTick(function () {
                        var e = r.find("input");
                        e && e.toggleClass("md-input", !0)
                    })), h.length > 0) {
                        var g = a(h.clone())(n.$parent);
                        c(function () {
            ...
            function l() {
                return{chips: t.processTemplate(n), input: t.processTemplate(o), "default": t.processTemplate(r), remove: t.processTemplate(i)}
            }

            var m = l();
            return{template: function (e, t) {
                return t.$mdUserTemplate = e.clone(), m.chips
            }, require: ["mdChips"], restrict: "E", controller: "MdChipsCtrl", controllerAs: "$mdChipsCtrl", bindToController: !0, compile: s, scope: {readonly: "=readonly", placeholder: "@", mdEnableChipEdit: "@", secondaryPlaceholder: "@", maxChips: "@mdMaxChips", transformChip: "&mdTransformChip", onAppend: "&mdOnAppend", onAdd: "&mdOnAdd", onRemove: "&mdOnRemove", onSelect: "&mdOnSelect", deleteHint: "@", deleteButtonLabel: "@", separatorKeys: "=?mdSeparatorKeys", requireMatch: "=?mdRequireMatch"}}
        }
        ...
        function e(e, t, n) {
            function o(o, r, i) {
                function a() {
                    var e = r.parent();
                    return e.attr("aria-label") || e.text() ? !0 : !(!e.parent().attr("aria-label") && !e.parent().text())
                }

                function d() {
                    i.mdSvgIcon || i.mdSvgSrc || (i.mdFontIcon && r.addClass("md-font " + i.mdFontIcon), r.addClass(e.fontSet(i.mdFontSet)))
                }

                t(r), d();
                var c = i.alt || i.mdFontIcon || i.mdSvgIcon || r.text(), s = i.$normalize(i.$attr.mdSvgIcon || i.$attr.mdSvgSrc || "");
        ...
        function r(n, o, r, i, a, d) {
            function c(e) {
                if (e = e || "", $[e])return r.when(l($[e]));
                if (M.test(e) || y.test(e))return h(e).then(m(e));
            ...
            function s(e) {
                ...
                return t.forEach(n.fontSets, function (t) {
                    t.alias == e && (r = t.fontSet || r)
                }), r
            }

            function l(e) {
                var n = e.clone(), o = "_cache" + d.nextUid();
            ...
            function m(e) {
                return function (t) {
                    return $[e] = g(t) ? t : new b(t, n[e]), $[e].clone()
                }
            }
            ...
            function p(e) {
                function t(t) {
                    var n = e.slice(e.lastIndexOf(":") + 1), r = t.querySelector("#" + n);
                    return r ? new b(r, d) : o(e)
                }
            ...
            function h(n) {
                function i(n) {
                    var o = y.exec(n), i = /base64/i.test(n), a = i ? e.atob(o[2]) : o[2];
                    return r.when(t.element(a)[0])
                }

                function d(e) {
                    return o.get(e, {cache: a}).then(function (e) {
                        return t.element("<div>").append(e.data).find("svg")[0]
                    })["catch"](f)
                }

                return y.test(n) ? i(n) : d(n)
            }
            ...
            function v() {
                ...
                t.forEach({fit: "", height: "100%", width: "100%", preserveAspectRatio: "xMidYMid meet", viewBox: this.element.getAttribute("viewBox") || "0 0 " + e + " " + e, focusable: !1}, function (e, t) {
            ...
            var $ = {}, M = /[-\w@:%\+.~#?&\/\/=]{2,}\.[a-z]{2,4}\b(\/[-\w@:%\+.~#?&\/\/=]*)?/i, y = /^data:image\/svg\+xml[\s*;\w\-\=]*?(base64)?,(.*)$/i;
            return b.prototype = {clone: E, prepare: v}, c.fontSet = s, c
        }

        t.module("material.components.icon").provider("$mdIcon", n);
        var i = {defaultViewBoxSize: 24, defaultFontSet: "material-icons", fontSets: []};
        n.prototype = {icon: function (e, t, n) {
            ...
            return i.fontSets.push({alias: e, fontSet: t || e}), this
            ...
            var t = this, n = [
                {id: "md-tabs-arrow", url: "md-tabs-arrow.svg", svg: '<svg version="1.1" x="0px" y="0px" viewBox="0 0 24 24"><g><polygon points="15.4,7.4 14,6 8,12 14,18 15.4,16.6 10.8,12 "/></g></svg>'},
                {id: "md-close", url: "md-close.svg", svg: '<svg version="1.1" x="0px" y="0px" viewBox="0 0 24 24"><g><path d="M19 6.41l-1.41-1.41-5.59 5.59-5.59-5.59-1.41 1.41 5.59 5.59-5.59 5.59 1.41 1.41 5.59-5.59 5.59 5.59 1.41-1.41-5.59-5.59z"/></g></svg>'},
                {id: "md-cancel", url: "md-cancel.svg", svg: '<svg version="1.1" x="0px" y="0px" viewBox="0 0 24 24"><g><path d="M12 2c-5.53 0-10 4.47-10 10s4.47 10 10 10 10-4.47 10-10-4.47-10-10-10zm5 13.59l-1.41 1.41-3.59-3.59-3.59 3.59-1.41-1.41 3.59-3.59-3.59-3.59 1.41-1.41 3.59 3.59 3.59-3.59 1.41 1.41-3.59 3.59 3.59 3.59z"/></g></svg>'},
                {id: "md-menu", url: "md-menu.svg", svg: '<svg version="1.1" x="0px" y="0px" viewBox="0 0 24 24"><path d="M3,6H21V8H3V6M3,11H21V13H3V11M3,16H21V18H3V16Z" /></svg>'},
                {id: "md-toggle-arrow", url: "md-toggle-arrow-svg", svg: '<svg version="1.1" x="0px" y="0px" viewBox="0 0 48 48"><path d="M24 16l-12 12 2.83 2.83 9.17-9.17 9.17 9.17 2.83-2.83z"/><path d="M0 0h48v48h-48z" fill="none"/></svg>'},
                {id: "md-calendar", url: "md-calendar.svg", svg: '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path d="M19 3h-1V1h-2v2H8V1H6v2H5c-1.11 0-1.99.9-1.99 2L3 19c0 1.1.89 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2zm0 16H5V8h14v11zM7 10h5v5H7z"/></svg>'}
            ];
            n.forEach(function (n) {
                t.icon(n.id, n.url), e.put(n.url, n.svg)
            })
        }, $get: ["$http", "$q", "$log", "$templateCache", "$mdUtil", function (e, t, n, o, a) {
            return this.preloadIcons(o), r(i, e, t, n, o, a)
        }]}, r.$inject = ["config", "$http", "$q", "$log", "$templateCache", "$mdUtil"]
    }(), function () {
        ...
        e.$inject = ["$scope", "$rootScope", "$element", "$attrs", "$mdConstant", "$document", "$mdUtil", "$timeout"], e.prototype.init = function () {
            ...
            e.on("keydown", this.handleKeyDown), this.parentToolbar = t.getClosest(e, "MD-TOOLBAR"), i.push(this.$rootScope.$on("$mdMenuOpen", function (t, n) {
                -1 != r.getMenus().indexOf(n[0]) && (e[0].classList.add("_md-open"), n[0].classList.add("_md-open"), r.currentlyOpenMenu = n.controller("mdMenu"), r.currentlyOpenMenu.registerContainerProxy(r.handleKeyDown), r.enableOpenOnHover())
            })), i.push(this.$rootScope.$on("$mdMenuClose", function (o, i, a) {
                var d = r.getMenus();
                if (-1 != d.indexOf(i[0]) && (e[0].classList.remove("_md-open"), i[0].classList.remove("_md-open")), e[0].contains(i[0])) {
            ...
            e ? this.$element[0].classList.add("_md-keyboard-mode") : this.$element[0].classList.remove("_md-keyboard-mode")
            ...
            var o = !1;
            return-1 == n ? (n = 0, o = !0) : (0 > e && n > 0 || e > 0 && n < t.length - e) && (n += e, o = !0), o ? (t[n].querySelector("button").focus(), t[n]) : void 0
            ...
            for (var e = this.getMenus(), t = 0; t < e.length; ++t)if (e[t].classList.contains("_md-open"))return t;
            return-1
        }
    }(), function () {
        function e(e, n) {
            return{restrict: "E", require: "mdMenuBar", controller: "MenuBarController", compile: function (o, r) {
                return r.ariaRole || o[0].setAttribute("role", "menubar"), t.forEach(o[0].children, function (n) {
                    if ("MD-MENU" == n.nodeName) {
                        ...
                        t.forEach(o, function (e) {
                            e.classList.add("_md-menu-bar-menu"), e.classList.add("md-dense"), e.hasAttribute("width") || e.setAttribute("width", 5)
                        })
                    }
                }), function (e, t, o, r) {
                    n(e, t), r.init()
        ...
        function e() {
            return{restrict: "E", compile: function (e, t) {
        ...
        function e() {
            return{require: ["mdMenuItem", "?ngModel"], priority: 210, compile: function (e, n) {
                function o(n, o, r) {
        ...
        function e(e, o, r, i, a, d, c, s) {
            ...
            this.nestLevel = parseInt(o.mdNestLevel, 10) || 0, this.init = function (n, o) {
                ...
                l.attr("id", d), t.element(m).attr({"aria-owns": d, "aria-haspopup": "true"}), i.$on("$destroy", this.disableHoverListener), l.on("$destroy", function () {
                    e.destroy()
                })
            };
            var p, h, f = [];
            this.enableHoverListener = function () {
                ...
                if (!u.isAlreadyOpening) {
                    ...
                    p = d(function () {
                        if (n && (n = t.element(n).controller("mdMenu")), u.currentlyOpenMenu && u.currentlyOpenMenu != n) {
                            var e = u.nestLevel + 1;
                            u.currentlyOpenMenu.close(!0, {closeTo: e}), u.isAlreadyOpening = !0, n.open()
                ...
                t && t.stopPropagation(), t && t.preventDefault(), u.isOpen || (u.enableHoverListener(), u.isOpen = !0, m = m || (t ? t.target : r[0]), m.setAttribute("aria-expanded", "true"), i.$emit("$mdMenuOpen", r), e.show({scope: i, mdMenuCtrl: u, nestLevel: u.nestLevel, element: l, target: m, preserveElement: !0, parent: "body"})["finally"](function () {
                    m.setAttribute("aria-expanded", "false"), u.disableHoverListener()
                }))
            }, i.$mdOpenMenu = this.open, i.$watch(function () {
                return u.isOpen
            }, function (e) {
                e ? (l.attr("aria-hidden", "false"), r[0].classList.add("_md-open"), t.forEach(u.nestedMenus, function (e) {
                    e.classList.remove("_md-open")
                })) : (l.attr("aria-hidden", "true"), r[0].classList.remove("_md-open")), i.$mdMenuIsOpen = u.isOpen
        ...
        function e(e) {
            function o(n) {
                ...
                return a && t.forEach(e.nodesToArray(a), function (e) {
                    e.hasAttribute("md-position-mode") || e.setAttribute("md-position-mode", "cascade"), e.classList.add("_md-nested-menu"), e.setAttribute("md-nest-level", d + 1)
                }), r
            }

            function r(e, o, r, i) {
                var a = i[0], d = i[1] != n, c = t.element('<div class="_md-open-menu-container md-whiteframe-z2"></div>'), s = o.children()[1];
        ...
        function e(e) {
            function o(e, o, a, d, c, s, l, m, u) {
                function p(n, o, r) {
                    return r.nestLevel ? t.noop : (r.disableParentScroll && !e.getClosest(r.target, "MD-DIALOG") ? r.restoreScroll = e.disableScrollAround(r.element, r.parent) : r.disableParentScroll = !1, r.hasBackdrop && (r.backdrop = e.createBackdrop(n, "_md-menu-backdrop _md-click-catcher"), u.enter(r.backdrop, d[0].body)), function () {
                ...
                function h(e, t, n) {
                    function o() {
                        return m(t, {addClass: "_md-leave"}).start()
                    }

                    function r() {
                        t.removeClass("_md-active"), v(t, n), n.alreadyOpen = !1
                    }
                ...
                function f(n, r, i) {
                    function d() {
                        return i.parent.append(r), r[0].style.display = "", s(function (e) {
                            var t = E(r, i);
                            r.removeClass("_md-leave"), m(r, {addClass: "_md-active", from: $.toCss(t), to: $.toCss({transform: ""})}).start().then(e)
                        })
                    }

                    function u() {
                        if (!i.target)throw Error("$mdMenu.show() expected a target to animate from in options.target");
                        t.extend(i, {alreadyOpen: !1, isRemoved: !1, target: t.element(i.target), parent: t.element(i.parent), menuContentEl: t.element(r[0].querySelector("md-menu-content"))})
                    }
                    ...
                    function f() {
                        ...
                        r.addClass("_md-clickable"), i.backdrop && i.backdrop.on("click", o), i.menuContentEl.on("keydown", t), i.menuContentEl[0].addEventListener("click", d, !0);
                        ...
                        return c && c.focus(), function () {
                            r.removeClass("_md-clickable"), i.backdrop && i.backdrop.off("click", o), i.menuContentEl.off("keydown", t), i.menuContentEl[0].removeEventListener("click", d, !0)
                        }
                    }
                ...
                function E(t, o) {
                    ...
                    var s, l = t[0], m = t[0].firstElementChild, u = m.getBoundingClientRect(), p = d[0].body, h = p.getBoundingClientRect(), f = c.getComputedStyle(m), g = o.target[0].querySelector("[md-menu-origin]") || o.target[0], b = g.getBoundingClientRect(), v = {left: h.left + i, top: Math.max(h.top, 0) + i, bottom: Math.max(h.bottom, Math.max(h.top, 0) + h.height) - i, right: h.right - i}, E = {top: 0, left: 0, right: 0, bottom: 0}, $ = {top: 0, left: 0, right: 0, bottom: 0}, M = o.mdMenuCtrl.positionMode();
                    "target" != M.top && "target" != M.left && "target-right" != M.left || (s = a(), s && (s = s.firstElementChild || s, s = s.querySelector("[md-menu-align-target]") || s, E = s.getBoundingClientRect(), $ = {top: parseFloat(l.style.top || 0), left: parseFloat(l.style.left || 0)}));
                    var y = {}, C = "top ";
                    switch (M.top) {
                        case"target":
                            y.top = $.top + b.top - E.top;
                            break;
                        case"cascade":
                    ...
                    switch (M.left) {
                        case"target":
                            y.left = $.left + b.left - E.left, C += A ? "right" : "left";
                            break;
                        case"target-left":
                            y.left = b.left, C += "left";
                            break;
                        case"target-right":
                            y.left = b.right - u.width + (u.right - E.right), C += "right";
                            break;
                        case"cascade":
                            var k = A ? b.left - u.width < v.left : b.right + u.width < v.right;
                            y.left = k ? b.right - g.style.left : b.left - g.style.left - u.width, C += k ? "left" : "right";
                            break;
                        case"left":
                            A ? (y.left = b.right - u.width, C += "right") : (y.left = b.left, C += "left");
                            break;
                        default:
                    ...
                    var w = Math.round(100 * Math.min(b.width / l.offsetWidth, 1)) / 100, _ = Math.round(100 * Math.min(b.height / l.offsetHeight, 1)) / 100;
                    return{top: Math.round(y.top), left: Math.round(y.left), transform: o.alreadyOpen ? n : e.supplant("scale({0},{1})", [w, _]), transformOrigin: C}
                }

                var $ = e.dom.animator;
                return{parent: "body", onShow: f, onRemove: h, hasBackdrop: !0, disableParentScroll: !0, skipCompile: !0, preserveScope: !0, skipHide: !0, themable: !0}
            }
            ...
            var i = 8;
            return o.$inject = ["$mdUtil", "$mdTheming", "$mdConstant", "$document", "$window", "$q", "$$rAF", "$animateCss", "$animate"], e("$mdMenu").setDefaults({methods: ["target"], options: o})
        }
        ...
        function e(e, n, o, r, i, a, d) {
            function c(d, c, l) {
                function h(t, r, a, c, l) {
                    var m = ++T, h = i.now(), f = r - t, g = u(d.mdDiameter), b = g - p(g), v = a || o.easeFn, E = c || o.duration;
                    r === t ? y.attr("d", s(r, g, b, l)) : e(function $(o) {
                        var r = n.Math.min((o || i.now()) - h, E);
                        y.attr("d", s(v(r, t, f, E), g, b, l)), m === T && E > r && e($)
                    })
                }

                function b() {
                    h(C, A, o.easeFnIndeterminate, o.durationIndeterminate, k), k = (k + A) % 100;
                    var e = C;
                    C = -A, A = -e
                }
                ...
                function v() {
                    if (!$) {
                        var t = i.now(), n = o.rotationDurationIndeterminate, r = u(d.mdDiameter) / 2;
                        r = " " + r + ", " + r, e(function s(a) {
                            var d = a || i.now(), c = d - t, l = o.easingPresets.linearEase(c, 0, 360, n);
                            y.attr("transform", "rotate(" + l + r + ")"), $ ? e(s) : y.removeAttr("transform"), c >= n && (t = d)
                        }), $ = a(b, o.durationIndeterminate + 50, 0, !1), b(), c.removeAttr("aria-valuenow")
                    }
                }
                ...
                var $, M = t.element(c[0].querySelector("svg")), y = t.element(c[0].querySelector("path")), C = o.startIndeterminate, A = o.endIndeterminate, k = 0, T = 0;
                r(c), d.mdMode === g && v(), d.$watchGroup(["value", "mdMode"], function (e, t) {
                    var n = e[1];
                    if (n !== f && n !== g && (n = g, l.$set("mdMode", n)), n === g)v(); else {
                        var o = m(e[0]);
                        E(), c.attr("aria-valuenow", o), h(m(t[0]), o)
                    }
                }), d.$watch("mdDiameter", function (e) {
                    var t = u(e), n = p(t), o = {width: t + "px", height: t + "px"};
                    M[0].setAttribute("viewBox", "0 0 " + t + " " + t), M.css(o), c.css(o), y.css("stroke-width", n + "px")
                })
            }

            function s(e, t, n, o) {
                var r, i = 3.5999, a = o || 0, d = t / 2, c = n / 2, s = a * i, m = e * i, u = l(d, c, s), p = l(d, c, m + s), h = 0 > m ? 0 : 1;
                return r = 0 > m ? m >= -180 ? 0 : 1 : 180 >= m ? 0 : 1, "M" + u + "A" + c + "," + c + " 0 " + r + "," + h + " " + p
            }

            function l(e, t, o) {
                var r = (o - 90) * h;
                return e + t * n.Math.cos(r) + "," + (e + t * n.Math.sin(r))
            }

            function m(e) {
                return n.Math.max(0, n.Math.min(e || 0, 100))
            }

            function u(e) {
                var t = o.progressSize;
                if (e) {
                    var n = parseFloat(e);
            ...
            function p(e) {
                return o.strokeWidth / 100 * e
            }

            var h = n.Math.PI / 180, f = "determinate", g = "indeterminate";
            return{restrict: "E", scope: {value: "@", mdDiameter: "@", mdMode: "@"}, template: '<svg xmlns="http://www.w3.org/2000/svg"><path fill="none"/></svg>', compile: function (e, n) {
                if (e.attr({"aria-valuemin": 0, "aria-valuemax": 100, role: "progressbar"}), t.isUndefined(n.mdMode)) {
                    var o = t.isDefined(n.value), r = o ? f : g, a = "Auto-adding the missing md-mode='{0}' to the ProgressCircular element";
                    d.debug(i.supplant(a, [r])), n.$set("mdMode", r)
                } else n.$set("mdMode", n.mdMode.trim());
                return c
            }}
        }

        t.module("material.components.progressCircular").directive("mdProgressCircular", e), e.$inject = ["$$rAF", "$window", "$mdProgressCircular", "$mdTheming", "$mdUtil", "$interval", "$log"]
    }(), function () {
        function e() {
            function e(e, t, n, o) {
                return n * e / o + t
            ...
            var o = {progressSize: 50, strokeWidth: 10, duration: 100, easeFn: e, durationIndeterminate: 500, startIndeterminate: 3, endIndeterminate: 80, rotationDurationIndeterminate: 2900, easeFnIndeterminate: n, easingPresets: {linearEase: e, materialEase: n}};
            return{configure: function (e) {
        ...
        function e() {
            function e(e, o, r, i) {
                if (i) {
                    var a = i.getTabElementIndex(o), d = n(o, "md-tab-body").remove(), c = n(o, "md-tab-label").remove(), s = i.insertTab({scope: e, parent: e.$parent, index: a, element: o, template: d.html(), label: c.html()}, a);
                    e.select = e.select || t.noop, e.deselect = e.deselect || t.noop, e.$watch("active", function (e) {
                        e && i.select(s.getIndex(), !0)
            ...
            return{require: "^?mdTabs", terminal: !0, compile: function (o, r) {
        ...
        function e() {
            return{require: "^?mdTabs", link: function (e, t, n, o) {
        ...
        function e(e, o, r, i, a, d, c, s, l, m) {
            function u() {
                se.selectedIndex = se.selectedIndex || 0, p(), f(), h(), m(o), d.nextTick(function () {
                    re(), ee(), ie(), se.tabs[se.selectedIndex] && se.tabs[se.selectedIndex].scope.select(), he = !0, Y()
                })
            }

            function p() {
                var e = s.$mdTabsTemplate, n = t.element(me.data);
                n.html(e), l(n.contents())(se.parent), delete s.$mdTabsTemplate
            }

            function h() {
                t.element(r).on("resize", I), e.$on("$destroy", v)
            }
            ...
            function v() {
                pe = !0, t.element(r).off("resize", I)
            }

            function E(e) {
                t.element(me.wrapper).toggleClass("md-stretch-tabs", z()), ie()
            }

            function $(e) {
                se.shouldCenterTabs = q()
            }

            function M(e, n) {
                e !== n && (t.forEach(me.tabs, function (t) {
                    t.style.maxWidth = e + "px"
                }), d.nextTick(se.updateInkBarStyles))
            }

            function y(e, t) {
                e !== t && (se.maxTabWidth = X(), se.shouldCenterTabs = q(), d.nextTick(function () {
                    se.maxTabWidth = X(), ee(se.selectedIndex)
                }))
            }
            ...
            function A(n) {
                var o = se.shouldCenterTabs ? "" : "-" + n + "px";
                t.element(me.paging).css(i.CSS.TRANSFORM, "translate3d(" + o + ", 0, 0)"), e.$broadcast("$mdTabsPaginationChanged")
            }
            ...
            function T(t, n) {
                t !== n && (se.selectedIndex = V(t), se.lastSelectedIndex = n, se.updateInkBarStyles(), re(), ee(t), e.$broadcast("$mdTabsChanged"), se.tabs[n] && se.tabs[n].scope.deselect(), se.tabs[t] && se.tabs[t].scope.select())
            }
            ...
            function x(e) {
                switch (e.keyCode) {
                    ...
                    case i.KEY_CODE.ENTER:
                        e.preventDefault(), le || (se.selectedIndex = se.focusIndex)
                }
                se.lastClick = !1
            }

            function N(e, t) {
                le || (se.focusIndex = se.selectedIndex = e), se.lastClick = !0, t && se.noSelectClick || d.nextTick(function () {
                    se.tabs[e].element.triggerHandler("click")
                }, !1)
            }

            function S(e) {
                se.shouldPaginate && (e.preventDefault(), se.offsetLeft = de(se.offsetLeft - e.wheelDelta))
            }

            function H() {
                var e, t, n = me.canvas.clientWidth, o = n + se.offsetLeft;
                for (e = 0; e < me.tabs.length && (t = me.tabs[e], !(t.offsetLeft + t.offsetWidth > o)); e++);
                se.offsetLeft = de(t.offsetLeft)
            }

            function D() {
                var e, t;
                for (e = 0; e < me.tabs.length && (t = me.tabs[e], !(t.offsetLeft + t.offsetWidth >= se.offsetLeft)); e++);
                se.offsetLeft = de(t.offsetLeft + t.offsetWidth - me.canvas.clientWidth)
            }

            function I() {
                se.lastSelectedIndex = se.selectedIndex, se.offsetLeft = de(se.offsetLeft), d.nextTick(function () {
                    se.updateInkBarStyles(), Y()
                })
            }

            function O(e) {
                t.element(me.inkBar).toggleClass("ng-hide", e)
            }
            ...
            function L(e) {
                if (!pe) {
                    var t = se.selectedIndex, n = se.tabs.splice(e.getIndex(), 1)[0];
                    oe(), se.selectedIndex === t && (n.scope.deselect(), se.tabs[se.selectedIndex] && se.tabs[se.selectedIndex].scope.select()), d.nextTick(function () {
                        Y(), se.offsetLeft = de(se.offsetLeft)
                    })
                }
            }

            function P(e, n) {
                var o = he, r = {getIndex: function () {
                    return se.tabs.indexOf(i)
                }, isActive: function () {
                    return this.getIndex() === se.selectedIndex
                }, isLeft: function () {
                    return this.getIndex() < se.selectedIndex
                }, isRight: function () {
                    return this.getIndex() > se.selectedIndex
                }, shouldRender: function () {
                    return!se.noDisconnect || this.isActive()
                }, hasFocus: function () {
                    return!se.lastClick && se.hasFocus && this.getIndex() === se.focusIndex
                }, id: d.nextUid()}, i = t.extend(r, e);
                return t.isDefined(n) ? se.tabs.splice(n, 0, i) : se.tabs.push(i), te(), ne(), d.nextTick(function () {
                    Y(), o && se.autoselect && d.nextTick(function () {
                        d.nextTick(function () {
                            N(se.tabs.indexOf(i))
                        })
                    })
            ...
            function B() {
                return se.offsetLeft > 0
            }

            function U() {
                var e = me.tabs[me.tabs.length - 1];
                return e && e.offsetLeft + e.offsetWidth > me.canvas.clientWidth + se.offsetLeft
            }

            function z() {
                switch (se.stretchTabs) {
                    case"always":
                        return!0;
                    case"never":
                        return!1;
                    default:
                        return!se.shouldPaginate && r.matchMedia("(max-width: 600px)").matches
                }
            }

            function q() {
                return se.centerTabs && !se.shouldPaginate
            }

            function j() {
                if (se.noPagination || !he)return!1;
            ...
            function V(e) {
                if (-1 === e)return-1;
                var t, n, o = Math.max(se.tabs.length - e, e);
                for (t = 0; o >= t; t++) {
                    if (n = se.tabs[e + t], n && n.scope.disabled !== !0)return n.getIndex();
                    if (n = se.tabs[e - t], n && n.scope.disabled !== !0)return n.getIndex()
                }
                return e
            }
            ...
            function Y() {
                K(), se.maxTabWidth = X(), se.shouldPaginate = j()
            }

            function K() {
                z() ? t.element(me.paging).css("width", "") : t.element(me.paging).css("width", G() + "px")
            }

            function G() {
                var e = 1;
                return t.forEach(F().dummies, function (t) {
                    e += Math.max(t.offsetWidth, t.getBoundingClientRect().width)
                }), Math.ceil(e)
            }
            ...
            function Q() {
                var e = se.tabs[se.selectedIndex], t = se.tabs[se.focusIndex];
                se.tabs = se.tabs.sort(function (e, t) {
                    return e.index - t.index
                }), se.selectedIndex = se.tabs.indexOf(e), se.focusIndex = se.tabs.indexOf(t)
            }

            function Z(e, t) {
                var n, o = t ? "focusIndex" : "selectedIndex", r = se[o];
                for (n = r + e; se.tabs[n] && se.tabs[n].scope.disabled; n += e);
                se.tabs[n] && (se[o] = n)
            }

            function J() {
                F().dummies[se.focusIndex].focus()
            }

            function ee(e) {
                if (null == e && (e = se.focusIndex), me.tabs[e] && !se.shouldCenterTabs) {
                    var t = me.tabs[e], n = t.offsetLeft, o = t.offsetWidth + n;
                    se.offsetLeft = Math.max(se.offsetLeft, de(o - me.canvas.clientWidth + 64)), se.offsetLeft = Math.min(se.offsetLeft, de(n))
                }
            }
            ...
            function ne() {
                var e = !1;
                t.forEach(se.tabs, function (t) {
                    t.template && (e = !0)
                }), se.hasContent = e
            }

            function oe() {
                se.selectedIndex = V(se.selectedIndex), se.focusIndex = V(se.focusIndex)
            }

            function re() {
                if (!se.dynamicHeight)return o.css("height", "");
                if (!se.tabs.length)return ue.push(re);
                var e = me.contents[se.selectedIndex], t = e ? e.offsetHeight : 0, r = me.wrapper.offsetHeight, i = t + r, a = o.prop("clientHeight");
                if (a !== i) {
                    "bottom" === o.attr("md-align-tabs") && (a -= r, i -= r, o.attr("md-border-bottom") !== n && ++a), le = !0;
                    var s = {height: a + "px"}, l = {height: i + "px"};
                    o.css(s), c(o, {from: s, to: l, easing: "cubic-bezier(0.35, 0, 0.25, 1)", duration: .5}).start().done(function () {
            ...
            function ie() {
                if (!me.tabs[se.selectedIndex])return void t.element(me.inkBar).css({left: "auto", right: "auto"});
                if (!se.tabs.length)return ue.push(se.updateInkBarStyles);
                if (!o.prop("offsetParent"))return _();
                var e, n = se.selectedIndex, r = me.paging.offsetWidth, i = me.tabs[n], a = i.offsetLeft, c = r - a - i.offsetWidth;
                se.shouldCenterTabs && (e = Array.prototype.slice.call(me.tabs).reduce(function (e, t) {
                    return e + t.offsetWidth
                }, 0), r > e && d.nextTick(ie, !1)), ae(), t.element(me.inkBar).css({left: a + "px", right: c + "px"})
            }

            function ae() {
                var e = se.selectedIndex, n = se.lastSelectedIndex, o = t.element(me.inkBar);
                t.isNumber(n) && o.toggleClass("md-left", n > e).toggleClass("md-right", e > n)
            }

            function de(e) {
                if (!me.tabs.length || !se.shouldPaginate)return 0;
                var t = me.tabs[me.tabs.length - 1], n = t.offsetLeft + t.offsetWidth;
                return e = Math.max(0, e), e = Math.min(n - me.canvas.clientWidth, e)
            }

            function ce(e, n) {
                var o = {colorElement: t.element(me.inkBar)};
                a.attach(e, n, o)
            }

            var se = this, le = !1, me = F(), ue = [], pe = !1, he = !1;
            g("stretchTabs", E), W("focusIndex", k, se.selectedIndex || 0), W("offsetLeft", A, 0), W("hasContent", C, !1), W("maxTabWidth", M, X()), W("shouldPaginate", y, !1), b("noInkBar", O), b("dynamicHeight", R), b("noPagination"), b("swipeContent"), b("noDisconnect"), b("autoselect"), b("noSelectClick"), b("centerTabs", $, !1), b("enableDisconnect"), se.scope = e, se.parent = e.$parent, se.tabs = [], se.lastSelectedIndex = null, se.hasFocus = !1, se.lastClick = !0, se.shouldCenterTabs = q(), se.updatePagination = d.debounce(Y, 100), se.redirectFocus = J, se.attachRipple = ce, se.insertTab = P, se.removeTab = L, se.select = N, se.scroll = S, se.nextPage = H, se.previousPage = D, se.keydown = x, se.canPageForward = U, se.canPageBack = B, se.refreshIndex = oe, se.incrementIndex = Z, se.getTabElementIndex = w, se.updateInkBarStyles = d.debounce(ie, 100), se.updateTabOrder = d.debounce(Q, 100), u()
        }
        ...
        function e() {
            return{scope: {selectedIndex: "=?mdSelected"}, template: function (e, t) {
